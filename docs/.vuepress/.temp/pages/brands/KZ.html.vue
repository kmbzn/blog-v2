<template><div><h1 id="kz-knowledge-zenith" tabindex="-1"><a class="header-anchor" href="#kz-knowledge-zenith"><span>KZ (Knowledge Zenith)</span></a></h1>
<DateMeta />
<p>KZ(Knowledge Zenith)는 중국 광둥성 선전(深圳)에 본사를 둔 음향 브랜드다. 저렴한 가격에 다수의 드라이버를 탑재한 인이어 모니터(IEM)를 주력으로 생산하며, 이른바 <strong>치파이(Chi-Fi, Chinese Hi-Fi)</strong> 시장을 대표하는 브랜드 중 하나다.</p>
...
<tbody>
<tr>
<td>DD (Dynamic Driver)</td>
<td>저음 표현에 강하고 자연스러운 음색. KZ 초기 라인업의 주류</td>
</tr>
<tr>
<td>BA (Balanced Armature)</td>
<td>중고음 해상도와 디테일 우수. 보청기 기술 기반</td>
</tr>
<tr>
<td>하이브리드 (DD+BA)</td>
<td>두 방식의 장점 결합. KZ의 주력 구성</td>
</tr>
<tr>
<td>평판형 (Planar)</td>
<td>넓은 음장, 낮은 왜율. 최근 KZ 상위 라인업에 도입</td>
</tr>
</tbody>
</table>
...
<ul>
<li><strong>AliExpress</strong> — 공식 KZ 스토어 운영, 가장 저렴</li>
