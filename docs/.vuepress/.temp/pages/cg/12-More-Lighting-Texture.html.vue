...
<li>자세한 내용은 LMS 게시글 참조:<br>
https://learning.hanyang.ac.kr/courses/178704/discussion_topics/418144</li>
<li>수정된 일정:
<ul>
<li>Lecture 12: 6월 5일</li>
<li>Lecture 13 (마지막 수업): 6월 12일 (Lab 없음)</li>
</ul>
</li>
</ul>
...
<ul>
<li>
<p>일시: 6월 18일 (수), 오후 6:30–7:30</p>
</li>
<li>
<p>장소: IT/BT Room 911</p>
</li>
<li>
<p>범위: Lecture 8–12, Lab 8–12</p>
</li>
<li>
<p>시험 시작 후 30분 전에는 퇴실할 수 없습니다. (시험을 일찍 끝내더라도)</p>
</li>
<li>
<p>즉, 시험 시작 후 30분 이후에는 입장할 수 없습니다. (지각 절대 금지!)</p>
</li>
<li>
<p>학생증을 반드시 지참할 것</p>
</li>
...
<ul>
<li>BRDF</li>
<li>Local &amp; Global Illumination</li>
</ul>
</li>
<li>
<p>Texture Mapping</p>
...
<li>개념</li>
<li>UV Mapping</li>
<li>Texture Mapping 과정</li>
<li>Texture 좌표 함수 정의</li>
<li>Texture가 적용된 객체 렌더링</li>
<li>Diffuse, Specular, Normal Map</li>
<li>Texture Map의 다양한 활용</li>
</ul>
</li>
</ul>
...
<ul>
<li>자동차 백미러의 강한 반사</li>
<li>분필 표면처럼 매우 diffuse한 재질</li>
...
<ul>
<li>반구(hemisphere): diffuse 성분 표현</li>
<li>lobe(로브): specular 성분을 cosⁿ(α) 형태로 표현</li>
</ul>
</li>
</ul>
...
<ul>
<li>기본 개념: 회전하는 광원과 회전하는 센서 사용</li>
</ul>
</li>
</ul>
...
<ul>
<li>광원에서 <strong>직접 오는 빛</strong>만을 모델링</li>
<li>빠르게 렌더링 가능하지만, 사실성이 떨어짐</li>
<li>예: Phong illumination 모델</li>
</ul>
</li>
</ul>
<p>(그림: Direct illumination 예시)</p>
<ul>
<li><strong>Global illumination</strong>
<ul>
<li>직접 조명 +</li>
<li>다른 물체에서 반사된 간접 조명 (inter-object reflections) 포함</li>
<li>훨씬 더 사실적</li>
<li>예: Ray tracing, Path tracing, Radiosity</li>
</ul>
</li>
</ul>
...
<ul>
<li>
<p><strong>표면상의 위치에 따라</strong> 표면 속성을 정의하는 기법</p>
</li>
<li>
<p>보통 2D texture 이미지(= texture map)를 3D 객체 표면에 적용</p>
</li>
<li>
<p>주요 목적: <strong>표면 디테일 추가</strong></p>
<ul>
<li>고폴리곤 모델보다</li>
<li>더 적은 폴리곤으로 높은 디테일 표현 가능</li>
<li>렌더링 속도 대폭 향상</li>
<li>texture map의 복잡도는 처리 복잡도에 영향 없음</li>
</ul>
</li>
</ul>
...
<ul>
<li>
<p>Texture mapping은 보통 <strong>UV mapping</strong>을 통해 정의됨</p>
</li>
<li>
<p>UV mapping: 2D 텍스처 좌표 (u, v)를 3D 모델의 각 정점에 매핑</p>
<ul>
<li>각 정점이 2D 이미지에서 어떤 위치에 대응되는지 설명</li>
</ul>
</li>
<li>
<p>UV mapping 함수는 <strong>texture coordinate function</strong>으로도 불림</p>
</li>
</ul>
...
<li>해당 UV 좌표를 텍스처 상의 점으로 매핑</li>
</ol>
<ul>
<li>Step 2는 단순 스케일링이며 시스템이 자동 수행</li>
...
<ul>
<li>물체 표면을 &quot;펼치기(Unwrap)&quot;
<ul>
<li>Blender 등 3D 모델링 툴에서 자동 수행됨</li>
</ul>
</li>
...
<ul>
<li>일부 최적화 알고리즘은 3D 객체를 펼칠 때 각 정점의 (u, v)를 부드럽고 왜곡이 적은 방식으로 선택</li>
<li>Blender, Maya 등 다양한 3D 모델링 툴은 각기 다른 unwrapping 알고리즘을 사용</li>
</ul>
</li>
</ul>
...
<ul>
<li>diffuse color, specular color</li>
<li>specular 지수, 투명도, 반사율 계수</li>
...
<p>(예시: Game of Thrones 캐릭터 텍스처)</p>
<ul>
<li>final 렌더링</li>
<li>diffuse</li>
<li>specular</li>
...
<ul>
<li>
<p>circle, sphere 비교</p>
</li>
<li>
<p>circle은 삼각형 개수가 적어 렌더링이 더 빠름</p>
</li>
<li>
<p>normal vector가 적절하면 circle도 sphere처럼 보일 수 있음</p>
</li>
<li>
<p>인간 시각은 실제 형상이 아닌 밝기 패턴으로 형태를 인식</p>
<ul>
<li>즉, 밝고 어두운 영역의 패턴은 normal에 의해 결정됨</li>
</ul>
</li>
</ul>
...
<ol>
<li>고폴리 모델의 normal을 텍스처 이미지에 somehow 인코딩</li>
...
<li>tangent space normal map에서는 픽셀 RGB가 u, v, w 축에 해당하는 normal 성분을 나타냄</li>
</ul>
<p>표기:</p>
<ul>
<li>
...
<li>
<p>w: 표면의 실제 normal 방향</p>
</li>
<li>
<p>R = Nᵤ, G = Nᵥ, B = Nʷ</p>
<ul>
<li>U: -1 to +1 → Red: 0 to 255</li>
<li>V: -1 to +1 → Green: 0 to 255</li>
<li>W: 0 to +1 → Blue: 128 to 255</li>
</ul>
</li>
<li>
<p>tangent space normal map이 푸르스름한 이유:</p>
<ul>
<li>대부분의 normal은 tangent space 기준 <code v-pre>(128, 128, 255)</code> 근처이기 때문</li>
</ul>
</li>
</ul>
...
<ul>
<li>
<p>목적은 normal mapping과 동일</p>
</li>
<li>
<p>핵심 아이디어:</p>
<ul>
<li>normal vector를 인코딩하는 대신 상대적인 높이(relative heights)를 저장
<ul>
<li>검정: 최소 높이 변화</li>
<li>흰색: 최대 높이 변화</li>
</ul>
...
<ul>
<li>
<p>height map의 높이 변화량을 참조하여 실제로 정점의 위치를 이동시킴</p>
<ul>
<li>bump/normal mapping과 달리 실루엣 및 자기 그림자(self-shadowing)가 자연스럽게 표현됨</li>
</ul>
</li>
<li>
<p>기본적으로 normal/bump처럼 정점 간의 세부 표현을 제공하지는 않음</p>
<ul>
<li>세부 표현을 높이려면 정점을 더 추가해야 하므로 연산량 증가</li>
</ul>
</li>
</ul>
...
<ul>
<li>https://threejs.org/examples/#webgl_materials_displacementmap</li>
</ul>
</li>
<li>Bump mapping
<ul>
<li>https://threejs.org/examples/#webgl_materials_bumpmap</li>
</ul>
</li>
</ul>
...
<ul>
<li>눈에는 보이지만 광원에 가려진 지점은 그림자로 표시됨</li>
</ul>
</li>
</ul>
...
<ul>
<li>객체 주변 환경을 텍스처로 캡처</li>
<li>표면 normal을 이용해 텍스처 좌표 계산</li>
</ul>
</li>
</ul>
...
<p>Light mapping</p>
<ul>
<li>https://threejs.org/examples/?q=light#webgl_lights_physical</li>
</ul>
</li>
<li>
<p>Shadow mapping</p>
<ul>
<li>https://threejs.org/examples/#webgl_shadowmap</li>
</ul>
</li>
<li>
<p>Environment mapping</p>
<ul>
<li>https://threejs.org/examples/#webgl_materials_cubemap_dynamic</li>
<li>https://threejs.org/examples/?q=refrac#webgl_materials_cubemap_refraction</li>
</ul>
</li>
</ul>
...
<ul>
<li>
<p>Pillow: 대중적인 파이썬 이미지 처리 라이브러리</p>
</li>
<li>
<p>설치:</p>
</li>
...
<li>VAO
<ul>
<li>이제 vertex 데이터에는 꼭짓점 위치와 색상뿐 아니라 텍스처 좌표도 포함됨</li>
</ul>
</li>
</ul>
<p>vertex 배열 구성 예시:</p>
...
<li>
<p>이미지를 로드하고 텍스처 객체를 생성하는 과정</p>
</li>
<li>
<p>텍스처 객체를 생성하고 바인딩: <code v-pre>glGenTextures</code>, <code v-pre>glBindTexture</code></p>
</li>
<li>
<p>이미지 로드: Pillow 라이브러리 사용 (<code v-pre>Image.open</code>)</p>
</li>
<li>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li><code v-pre>glTexImage2D(target, level, internalformat, width, height, border, format, type, data)</code>
<ul>
<li><code v-pre>target</code>: 텍스처 대상. GL_TEXTURE_2D로 설정</li>
<li><code v-pre>level</code>: 디테일 레벨. 보통 0 (glGenerateMipmap 사용 시 변경 가능)</li>
<li><code v-pre>internalformat</code>: 텍스처를 저장할 내부 포맷</li>
<li><code v-pre>width</code>, <code v-pre>height</code>: 이미지 크기</li>
<li><code v-pre>border</code>: <code v-pre>0</code> (레거시 값)</li>
<li><code v-pre>format</code>, <code v-pre>type</code>: 원본 이미지의 포맷과 데이터 타입</li>
<li><code v-pre>data</code>: 메모리 상의 이미지 데이터</li>
</ul>
</li>
...
<li>아직 uniform 변수 <code v-pre>texture1</code>의 값을 설정하지 않음</li>
<li>GLSL에서는 sampler uniform이 기본값 0으로 설정된다는 보장이 없음</li>
<li>대부분 드라이버에서 기본값이 0(GL_TEXTURE0)이기 때문에 잘 작동하지만,<br>
...
<span class="line">        <span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>(이미지 설명: 확대된 삼각형에 저해상도 텍스처가 뚜렷하게 보임)</p>
<ul>
<li>더 부드러운 결과를 얻으려면?</li>
</ul>
<p>(이미지 설명: 왼쪽은 GL_NEAREST로 픽셀이 뚜렷함, 오른쪽은 <code v-pre>GL_LINEAR로</code> 보간되어 부드럽게 표현됨)</p>
<ul>
<li>텍스처 필터링(Texture filtering)은 주어진 <code v-pre>(u, v)</code>에 대한 색상 값을 계산하는 방식 지정</li>
<li>텍스처 좌표는 실수이므로 정확히 픽셀 중심과 일치하지 않을 수 있음</li>
<li><code v-pre>GL_NEAREST</code>: 가장 가까운 텍셀(texel)의 색상을 사용 (픽셀화된 결과)</li>
<li><code v-pre>GL_LINEAR</code>: 주변 텍셀을 보간하여 색상을 계산 (부드러운 결과)
(이미지 설명: 좌측은 Nearest 필터, 우측은 Linear 필터에 따른 픽셀 시각화 예시)</li>
<li><code v-pre>MIN</code> 필터와 <code v-pre>MAG</code> 필터를 구분해서 설정 가능</li>
...
<li>이를 해결하기 위해 <strong>mipmap</strong> 사용
<ul>
<li>mipmap은 동일 텍스처의 해상도를 점점 낮춘 이미지 집합</li>
<li>객체와의 거리 등에 따라 적절한 해상도의 레벨을 선택해 사용</li>
<li>OpenGL은 자동으로 적절한 mipmap 레벨을 선택</li>
</ul>
</li>
</ul>
...
<p>텍스처 래핑 방식 4가지:</p>
<ul>
<li><code v-pre>GL_REPEAT</code>: 기본값, 텍스처 반복</li>
<li><code v-pre>GL_MIRRORED_REPEAT</code>: 반전하며 반복</li>
<li><code v-pre>GL_CLAMP_TO_EDGE</code>: 가장자리를 늘림</li>
<li><code v-pre>GL_CLAMP_TO_BORDER</code>: 테두리 색상으로 채움</li>
</ul>
</li>
</ul>
...
<p>(이미지 설명: 왼쪽은 diffuse map, 가운데는 specular map, 오른쪽은 결과 큐브)</p>
<ul>
<li><code v-pre>glUniform1i</code>를 사용하여 sampler uniform에 texture unit의 위치를 할당 가능</li>
<li>이를 통해 fragment shader에서 <strong>여러 텍스처를 동시에 사용할 수 있음</strong></li>
<li>기본 방식:
<ul>
<li>각 sampler 변수에 대해 <code v-pre>glUniform1i</code>로 texture unit 인덱스 지정</li>
<li><code v-pre>glActiveTexture(GL_TEXTUREi)</code>로 활성화</li>
<li><code v-pre>glBindTexture(GL_TEXTURE_2D, texture)</code>로 바인딩</li>
</ul>
</li>
</ul>
<p>(요약: diffuse map과 specular map을 동시에 사용하는 구조)</p>
<ul>
<li><code v-pre>8-Lab-Lighting/4-all-components-phong-faceonvm.py</code>에서 시작</li>
<li>Pillow import</li>
<li>VAO의 vertex data에 texture coordinate 추가</li>
<li>sampler uniform 변수 <code v-pre>texture_diffuse</code>, <code v-pre>texture_specular</code>를 텍스처 객체에 연결</li>
