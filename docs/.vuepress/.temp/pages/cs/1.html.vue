...
<ul>
<li>&quot;정보 시스템 자원(하드웨어, 소프트웨어, 펌웨어, 정보/데이터, 통신 포함)의 무결성, 가용성, 기밀성을 보존하는 적용 가능한 목표를 달성하기 위해 자동화된 정보 시스템에 부여되는 보호.&quot;</li>
</ul>
</li>
</ul>
...
<ul>
<li>데이터 기밀성</li>
<li>Privacy(개인 정보 보호)</li>
</ul>
</li>
<li>Integrity(무결성)
<ul>
<li>데이터 무결성</li>
<li>시스템 무결성(OS나 펌웨어)</li>
</ul>
</li>
...
<li>Confidentiality
<ul>
<li>개인 privacy 및 독점 정보 보호 수단을 포함한 정보 접근 및 공개를 <strong>허용된 권한에 한해서만 가능</strong>하도록 제한</li>
</ul>
</li>
<li>Integrity
<ul>
<li>정보의 부인 방지 및 인증 보장을 포함하여 <strong>부적절한 정보 수정 또는 파괴</strong>로부터 보호</li>
</ul>
</li>
<li>Availability
<ul>
<li>정보에 대해 timely하고, 신뢰할 수 있는 접근 및 사용을 보장</li>
</ul>
</li>
</ul>
...
<ul>
<li>사용자 식별: ID, PW를 사용한 방법, 생체 인증 등</li>
</ul>
</li>
<li>Authorization(인가)
<ul>
<li>인증된 사용자가 특정 작업을 수행하도록 허용</li>
<li>사용자가 그러한 명령을 내릴 권한이 있는지 결정, 판단</li>
</ul>
</li>
<li>Accounting
<ul>
<li>사용자가 접근하는 동안 소비하는 자원을 측정</li>
</ul>
</li>
</ul>
...
<li>(추가된) 보안 기능에 대한 잠재적 공격을 고려해야 함.</li>
<li>특정 서비스를 제공하는 데 사용되는 절차는 종종 직관에 반대됨.</li>
<li>물리적 및 논리적 배치 위치를 결정해야 함.</li>
<li>추가적인 여러 알고리즘이나 프로토콜이 관련될 수 있음.</li>
<li>공격자는 단 하나의 약점만 찾으면 되지만, 개발자(방어자)는 모든 약점을 찾아야 함.</li>
<li>사용자와 시스템 관리자는 장애가 발생하기 전까지 보안의 이득을 알아보지 못하는 경향이 있음.</li>
<li>보안은 정기적이고 지속적인 모니터링을 요구함.</li>
<li>종종 설계가 완료된 후 시스템에 통합되는 사후 고려 사항으로 취급(오해)됨.
<ul>
<li>초기 단계부터 보안을 고려하여 개발하는 것이 중요</li>
</ul>
</li>
...
<li>Adversary(threat agent) (적대자 (위협 행위자))
<ul>
<li>시스템을 공격하거나 시스템에 위협이 되는 개체</li>
</ul>
</li>
<li>Attack(공격)
<ul>
<li>지능적인 위협에서 비롯된 시스템 보안에 대한 공격; 즉, 보안 서비스를 회피하고 시스템의 보안 정책을 위반하려는 의도적인 행위(특히 방법이나 기술의 의미에서)</li>
</ul>
</li>
<li>Countermeasure(countermeasure)
<ul>
<li>위협, 취약점 또는 공격을 제거하거나 예방하고, 발생할 수 있는 피해를 최소화하거나, 시정 조치를 취할 수 있도록 발견하고 보고함으로써 위협을 감소시키는 조치, 장치, 절차 또는 기술</li>
</ul>
</li>
<li>Risk(위험)
<ul>
<li>특정 위협이 특정 취약점을 악용하여 특정 유해한 결과를 초래할 확률로 표현되는 손실 기대치, 기댓값</li>
</ul>
</li>
<li>Security Policy(보안 정책)
<ul>
<li>민감하고 중요한 시스템 자원을 보호하기 위해 시스템이나 조직이 보안 서비스를 제공하는 방법을 명시하거나 규제하는 규칙 및 관행의 집합</li>
</ul>
</li>
<li>System Resource(Asset) (시스템 자원(자산))
<ul>
<li>정보 시스템에 포함된 데이터</li>
<li>시스템이 제공하는 서비스</li>
<li>처리 능력이나 통신 대역폭과 같은 시스템 기능</li>
<li>또는 시스템 장비 항목(예: 시스템 구성 요소 - 하드웨어, 펌웨어, 소프트웨어 또는 문서)</li>
<li>시스템 운영 및 장비를 수용하는 시설</li>
</ul>
</li>
<li>Threat(위협)
<ul>
<li>보안을 위반하고 해를 끼칠 수 있는 상황, 능력, 조치 또는 사건이 있을 때 존재하는 보안 위반 가능성.</li>
<li>즉, 위협이란 취약점을 악용할 수 있는 <strong>잠재적인 위험</strong></li>
</ul>
</li>
<li>Vulnerability(취약점)
<ul>
<li>시스템의 보안 정책을 위반하는 데 악용될 수 있는 시스템의 설계, 구현 또는 운영 및 관리상의 결함이나 약점</li>
</ul>
</li>
</ul>
...
<li>소유자는 위험(risk)을 최소화하고자 함</li>
<li>소유자는 대책(countermeasures)을 부과함</li>
<li>위협 행위자(Threat agents)는 위협(threats)을 야기함</li>
<li>위협은 자산을 남용(abuse)하거나 손상시키고자 함</li>
<li>위협은 취약점(vulnerabilities)을 악용함</li>
<li>위협은 risk를 증가시킴</li>
<li>취약점은 risk로 이어짐</li>
<li>Risk는 자산에 대한 것임</li>
<li>countermeasure는 취약점을 줄임</li>
...
<li>손상됨 (무결성 상실)</li>
<li>유출됨 (기밀성 상실)</li>
<li>사용할 수 없거나 매우 느림 (가용성 상실)</li>
</ul>
</li>
<li>위협(Threats)
<ul>
<li>취약점을 악용할 수 있음</li>
<li>자산에 대한 잠재적인 보안 위협을 나타냄</li>
</ul>
</li>
<li>공격(Attacks) (실행된 위협)
<ul>
<li>Passive(수동적)
<ul>
<li>시스템 자원을 바꾸거나 영향을 미치지 않음.</li>
<li>(예: traffic capture)</li>
</ul>
</li>
<li>Active(능동적)
<ul>
<li>시스템 자원을 변경하거나 운영에 영향을 미치려는 시도</li>
</ul>
</li>
<li>Insider(내부자)
<ul>
<li>보안 경계 내부의 개체에 의해 시작됨</li>
<li>내부자에 의한 공격이 일반적으로 더 많음.</li>
</ul>
</li>
<li>Outsider(외부자)
<ul>
...
<li>Passive attacks
<ul>
<li>시스템으로부터 정보를 배우거나 사용하려고 시도하지만, 시스템 자원에는 <strong>영향을 미치지 않음</strong></li>
<li>전송 도청/모니터링</li>
<li>탐지의 어려움</li>
<li>탐지보다는 <strong>예방</strong>에 중점, (예: 패킷 암호화)</li>
<li>두 가지 유형:
<ul>
<li>메시지 내용 공개</li>
<li>트래픽 분석(암호화 때문에 내용을 볼 수는 없지만 패킷의 양을 분석해서 공격하는 방법)
<ul>
<li>걸프전 발발 직전 펜타곤으로의 피자 주문량 증가</li>
</ul>
</li>
</ul>
</li>
...
<li>Active attacks
<ul>
<li>데이터 스트림의 modification을 포함</li>
<li>목표는 이를 탐지한 후 복구하는 것</li>
<li>네 가지 범주:
<ul>
<li>Masquerade(위장)</li>
<li>Replay(재전송)</li>
<li>Modification of messages(메시지 수정)</li>
<li>Denial of service(서비스 거부, DoS): 가용성에 대한 공격</li>
</ul>
</li>
</ul>
</li>
...
<ul>
<li>Data(데이터)</li>
<li>Processes representing users(사용자를 대표하는 프로세스)</li>
<li>Guard(가드)</li>
<li>Users making requests(요청하는 사용자)</li>
</ul>
</li>
</ul>
<ol>
<li>데이터에 대한 접근 통제 (Protection)</li>
<li>컴퓨터 시설에 대한 접근 통제 (User authentication)</li>
...
<li>결함을 수정하고 조직 정보 시스템의 취약점을 줄이거나 제거하기 위해 고안된 조치 계획을 개발하고 구현함.</li>
...
<li>정보 시스템을 위한 물리적 설비 및 지원 기반 시설을 보호함.</li>
<li>정보 시스템을 위한 지원 유틸리티를 제공함.</li>
...
<li>정보 보안 고려 사항을 통합하는 시스템 개발 수명 주기 프로세스를 채용함.</li>
...
<ul>
<li>접근 통제(access control); 식별 및 인증(identification &amp; authentication); 시스템 및 통신 보호(system &amp; communication protection); 시스템 및 정보 무결성(system &amp; information integrity)</li>
</ul>
</li>
<li>주로 관리 통제 및 절차가 필요한 기능 영역:
<ul>
<li>인식 및 훈련; 감사 및 책임; 인증, 인가 및 보안 평가; 비상 계획; 유지보수; 물리적 및 환경적 보호; 계획; 인사 보안; 위험 평가; 시스템 및 서비스 획득</li>
</ul>
</li>
<li>컴퓨터 보안 기술적 조치와 관리 통제가 겹치는 기능 영역:
<ul>
<li>형상 관리; 사고 대응; 미디어 보호</li>
</ul>
</li>
</ul>
...
<ul>
<li>보안 요구사항을 정의하고 이를 만족시키는 접근 방식을 특성화하는 체계적인 방법</li>
<li>국제 표준으로 개발됨</li>
<li>초점
<ul>
<li>Security attacks – 조직이 소유한 정보의 보안을 침해하는 행위</li>
<li>Security mechanism – 보안 공격을 탐지, 예방 또는 복구하도록 설계된 메커니즘</li>
<li>Security service – 보안 공격에 대응하기 위한 서비스</li>
</ul>
</li>
</ul>
</li>
...
<ul>
<li>통신하는 개방형 시스템의 프로토콜 계층에 의해 제공되며, 시스템 또는 데이터 전송의 적절한 보안을 보장하는 서비스로 정의</li>
</ul>
</li>
<li><code v-pre>RFC 2828</code>
<ul>
<li>시스템 자원에 특정 종류의 보호를 제공하기 위해 시스템에 의해 제공되는 처리 또는 통신 서비스로 정의</li>
<li>Security services는 보안 정책(security policies)을 구현</li>
<li>Security mechanisms에 의해 구현됨</li>
</ul>
</li>
</ul>
...
<li>연결이 두 합법적인 당사자 중 하나로 가장하는 제3자에 의해 방해받지 않음을 보장해야 함</li>
<li>Data Origin Authentication
<ul>
<li>데이터 단위의 출처를 확증하기 위해 제공됨</li>
<li>데이터 단위의 복제나 수정에 대한 보호는 제공하지 않음</li>
<li>이 유형의 서비스는 통신 엔티티 간에 사전 상호작용이 없는 이메일과 같은 애플리케이션을 지원</li>
</ul>
</li>
<li>Peer Entity Authentication
<ul>
<li>연관 관계에 있는 피어 엔티티의 신원을 확증하기 위해 제공됨</li>
<li>연결 설정 시 또는 데이터 전송 단계 동안 사용됨</li>
<li>엔티티가 가장이나 이전 연결의 무단 재전송을 수행하지 않는다는 신뢰를 제공하려는 시도</li>
</ul>
</li>
</ul>
...
<li>가장 광범위한 서비스는 일정 기간 동안 두 사용자 간에 전송된 모든 사용자 데이터를 보호</li>
<li>Connection confidentiality
<ul>
<li>연결상의 모든 사용자 데이터 보호</li>
<li>트래픽 흐름이 분석되는 것을 보호</li>
<li>공격자가 통신 시설에서 트래픽의 출처, 목적지, 빈도, 길이 또는 기타 특성을 관찰할 수 없어야 함</li>
</ul>
</li>
<li>Connectionless confidentiality
<ul>
<li>단일 데이터 블록 내 모든 사용자 데이터 보호</li>
</ul>
</li>
<li>Selective-field confidentiality
<ul>
<li>연결 또는 단일 데이터 블록의 사용자 데이터 내 선택된 필드의 기밀성</li>
</ul>
</li>
<li>Traffic-flow confidentiality
<ul>
<li>트래픽 흐름 관찰로부터 파생될 수 있는 정보의 보호</li>
</ul>
</li>
</ul>
...
<li>Connectionless integrity service는 일반적으로 메시지 수정에 대한 보호만 제공</li>
<li>Connection-oriented integrity service는 메시지가 복제, 삽입, 수정, 재정렬 또는 재전송 없이 전송된 대로 수신됨을 보장
<ul>
<li>데이터 파괴도 이 서비스에 포함됨</li>
<li>메시지 스트림 수정과 서비스 거부 둘 다를 다룸</li>
<li>복구 기능이 있는 서비스와 없는 서비스를 구별할 필요가 있음.</li>
<li>예방보다는 탐지와 관련됨</li>
<li>자동화된 복구 메커니즘의 통합이 더 매력적인 대안</li>
</ul>
</li>
</ul>
...
<ul>
<li>시스템 또는 시스템 자원이 승인된 시스템 엔티티에 의해 시스템의 성능 사양에 따라 요구 시 접근 가능하고 사용 가능한 속성으로 정의됨</li>
</ul>
</li>
<li>다양한 공격이 가용성의 상실 또는 감소를 초래할 수 있음.</li>
<li>이러한 공격 중 일부는 인증 및 암호화로 대응 가능</li>
<li>일부 공격은 가용성 상실을 방지하거나 복구하기 위해 물리적 조치가 필요</li>
<li>X.800은 가용성을 다양한 보안 서비스와 연관될 속성으로 취급</li>
...
<li><strong>Encipherment</strong>(암호화)
<ul>
<li>수학적 알고리즘을 사용하여 데이터를 쉽게 읽을 수 없는 형태로 변환</li>
<li>데이터의 후속 복구는 알고리즘과 하나 이상의 암호화 키에 의존</li>
</ul>
</li>
<li><strong>Digital Signature</strong>(디지털 서명)
<ul>
<li>데이터 단위에 추가되거나, 데이터 단위의 암호화 변환으로, 수신자가 데이터 단위의 출처와 무결성을 증명하고 위조로부터 보호할 수 있도록 하는 데이터</li>
</ul>
</li>
<li><strong>Access Control</strong>(접근 제어)
<ul>
<li>리소스에 대한 접근 권한을 강제하는 다양한 메커니즘</li>
</ul>
</li>
<li>Data Integrity(데이터 무결성)
<ul>
<li>데이터 단위 또는 데이터 단위 스트림의 무결성을 보장하는 데 사용되는 다양한 메커니즘</li>
</ul>
</li>
<li>Authentication Exchange(인증 교환)
<ul>
<li>정보 교환을 통해 개체의 신원을 보장하기 위한 메커니즘</li>
</ul>
</li>
<li><strong>Traffic Padding</strong>(트래픽 패딩)
<ul>
<li>트래픽 분석 시도를 좌절시키기 위해 데이터 스트림의 간격에 비트를 삽입</li>
</ul>
</li>
<li>Routing Control(라우팅 제어)
<ul>
<li>특정 데이터에 대해 물리적으로 안전한 특정 경로 선택을 가능하게 하고, 특히 보안 침해가 의심될 때 라우팅 변경을 가능하게 함</li>
</ul>
</li>
<li><strong>Notarization</strong>(공증)
<ul>
<li>데이터 교환의 특정 속성을 보장하기 위해 신뢰할 수 있는 제3자를 사용(내용증명)</li>
</ul>
</li>
</ul>
...
<li>Trusted Functionality(신뢰된 기능)
<ul>
<li>보안 정책에 의해 설정된 것과 같이 특정 기준에 따라 올바른 것으로 인식되는 기능</li>
</ul>
</li>
<li>Security Label(보안 레이블)
<ul>
<li>리소스에 대한 마킹으로, 해당 리소스의 보안 속성을 명명하거나 지정</li>
</ul>
</li>
<li>Event Detection(이벤트 탐지)
<ul>
<li>보안 관련 이벤트 탐지</li>
</ul>
</li>
<li>Security Audit Trail(보안 감사 추적)
<ul>
<li>보안 감사를 용이하게 하기 위해 수집되고 잠재적으로 사용되는 데이터로, 시스템 기록 및 활동의 독립적인 검토 및 조사</li>
</ul>
</li>
<li>Security Recovery(보안 복구)
<ul>
<li>이벤트 처리 및 관리 기능과 같은 요청을 처리하고 복구 조치를 수행</li>
</ul>
</li>
</ul>
...
<ul>
<li>보안 체계가 <strong>무엇을</strong> 해야 하는가?</li>
</ul>
</li>
<li>Implementation/mechanisms
<ul>
<li><strong>어떻게</strong> 그것을 하는가?</li>
</ul>
</li>
<li>Correctness/assurance
<ul>
<li><strong>정말로 작동</strong>하는가?</li>
</ul>
</li>
</ul>
...
<li>보호받는 자산의 가치</li>
<li>시스템의 취약점</li>
<li>잠재적 위협 및 공격 가능성</li>
</ul>
</li>
<li>고려해야 할 trade-off
<ul>
<li>사용 편의성 vs 보안</li>
<li>보안 비용 vs 실패, 복구 비용</li>
</ul>
</li>
</ul>
...
<li>Response(대응)
<ul>
<li>탐지 시, 공격을 중단시키고 추가 피해를 방지할 수 있는 능력</li>
</ul>
</li>
<li>Recovery(복구)
<ul>
...
<ul>
<li>보안 조치가 시스템과 처리하는 정보를 보호하기 위해 의도한 대로 작동한다는 <em>신뢰의 정도</em></li>
<li>시스템 설계와 시스템 구현 모두를 포함</li>
<li>Common Criteria (CC) 인증 도입, (예: S사의 스마트 TV)</li>
</ul>
</li>
<li>Evaluation (평가)
<ul>
<li>특정 기준에 따라 컴퓨터 제품 또는 시스템을 검사하는 과정</li>
<li>테스트 및 공식적인 분석 또는 수학적 기법을 포함</li>
<li>EAL 1~7 정의되어 있음.
<ul>
<li>1~2(간단한 단계)는 국제적으로 상호 인증</li>
<li>3~4(source code)</li>
<li>5~7(화력, 원자력 발전소의 formal verification, 고등급의 수학적 인증, 증명)</li>
</ul>
</li>
</ul>
</li>
...
<ul>
<li>CIA triad</li>
<li>Confidentiality – 정보 공개 보존</li>
<li>Integrity – 정보의 수정 또는 파괴로부터 보호</li>
<li>Availability – 정보에 대한 시기적절하고 신뢰할 수 있는 접근 보장</li>
</ul>
</li>
<li>Terminology – Table 1.1
<ul>
<li>Threats – 취약점을 악용</li>
<li>Attack – 실행된 위협</li>
<li>Countermeasure – 보안 공격에 대처하는 수단</li>
<li>Assets – 하드웨어, 소프트웨어, 데이터, 통신 회선, 네트워크</li>
</ul>
</li>
<li>Security architecture
<ul>
<li>Security services – 시스템 및 정보 전송의 보안을 강화, Table 1.5</li>
<li>Security mechanisms – 보안 공격을 탐지, 예방 또는 복구하도록 설계된 메커니즘, Table 1.6</li>
<li>Security attack – 조직이 소유한 정보의 보안을 침해하는 모든 행위</li>
</ul>
</li>
