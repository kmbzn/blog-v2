...
<li>Multiprogramming은 CPU가 항상 실행할 작업을 갖도록 작업(코드 및 데이터)을 구성</li>
...
<tbody>
<tr>
<td><code v-pre>gets(char *str)</code></td>
<td>Read line from standard input into str</td>
</tr>
<tr>
<td><code v-pre>sprintf(char *str, char *format, ...)</code></td>
<td>Create str according to supplied format and variables</td>
</tr>
<tr>
<td><code v-pre>strcat(char *dest, char *src)</code></td>
<td>Append contents of string src to string dest</td>
</tr>
<tr>
<td><code v-pre>strcpy(char *dest, char *src)</code></td>
<td>Copy contents of string src to string dest</td>
</tr>
<tr>
<td><code v-pre>vsprintf(char *str, char *fmt, va_list ap)</code></td>
<td>Create str according to supplied format and variables</td>
</tr>
</tbody>
</table>
...
<tr>
<td><code v-pre>RET</code></td>
<td>함수로부터 반환</td>
</tr>
<tr>
<td><code v-pre>INT num</code></td>
<td>Operating system 함수에 접근하기 위한 소프트웨어 interrupt</td>
</tr>
<tr>
<td><code v-pre>NOP</code></td>
...
<tbody>
<tr>
<td><code v-pre>%eax</code></td>
<td><code v-pre>%ax</code></td>
<td><code v-pre>%ah</code></td>
<td><code v-pre>%al</code></td>
<td>산술 및 I/O 연산과 interrupt 호출 실행에 사용되는 accumulator</td>
</tr>
<tr>
<td><code v-pre>%ebx</code></td>
<td><code v-pre>%bx</code></td>
<td><code v-pre>%bh</code></td>
<td><code v-pre>%bl</code></td>
<td>메모리 접근, system call 인자 및 반환 값 전달에 사용되는 base register</td>
</tr>
<tr>
<td><code v-pre>%ecx</code></td>
<td><code v-pre>%cx</code></td>
<td><code v-pre>%ch</code></td>
<td><code v-pre>%cl</code></td>
<td>Counter register</td>
</tr>
<tr>
<td><code v-pre>%edx</code></td>
<td><code v-pre>%dx</code></td>
<td><code v-pre>%dh</code></td>
<td><code v-pre>%dl</code></td>
<td>산술 연산, interrupt 호출 및 I/O 연산에 사용되는 data register</td>
</tr>
<tr>
<td><code v-pre>%ebp</code></td>
<td></td>
<td></td>
<td></td>
...
<li>Exploit 예
<ul>
<li><code v-pre>A * 80 + B * 4 + &quot;\xe0\x8a\x05\x40&quot; + &quot;AAAA&quot; + &quot;\xf9\xbf\x0f\x40&quot;</code></li>
<li><code v-pre>0x40058ae0</code></li>
<li><code v-pre>0x400fbff9</code></li>
</ul>
</li>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code class="language-bash"><span class="line">$ <span class="token function">cat</span> attack2</span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code class="language-bash"><span class="line">$ <span class="token function">cat</span> attack3</span>
<span class="line"><span class="token comment">#!/bin/sh</span></span>
...
<li>원본 코드 수정 필요 없음.
<ul>
<li>하지만 여전히 stack 내용(반환 주소 포함)을 변경해야 함.</li>
</ul>
</li>
</ul>
</li>
...
<li>아이디어
<ul>
<li>(shellcode 주입, <code v-pre>lib</code> 함수 호출, 코드 수정 없이) 임의의 계산을 수행할 수 있음.</li>
</ul>
</li>
<li>접근 방식
<ul>
<li>전체 함수를 사용하는 대신 작은 명령어 시퀀스(예: <code v-pre>libc</code>의)를 사용함.</li>
...
<tbody>
<tr>
<td><code v-pre>b8 13 00 00 00</code></td>
<td><code v-pre>mov </code>0x13,%eax`</td>
<td><code v-pre>/* move 0x13 to the %eax register */</code></td>
</tr>
<tr>
<td><code v-pre>e9 c3 f8 ff ff</code></td>
<td><code v-pre>jmp 3aae9</code></td>
<td><code v-pre>/* jump to (relative) address 3aae9 */</code></td>
</tr>
</tbody>
</table>
</li>
<li><code v-pre>b8</code> 대신 <code v-pre>00</code>부터 바이트 스트림을 해석하면, 다음과 같은 의도하지 않은 명령어 시퀀스를 얻을 수 있음.
<table>
<thead>
<tr>
<th>Byte values</th>
...
<tbody>
<tr>
<td><code v-pre>00 00</code></td>
<td><code v-pre>add %al, (%eax)</code></td>
<td><code v-pre>/* add register value of %al to the word pointed to by the %eax register */</code></td>
</tr>
<tr>
<td><code v-pre>00 e9</code></td>
<td><code v-pre>add %ch,%cl</code></td>
<td><code v-pre>/* add registers %cl and %ch */</code></td>
</tr>
<tr>
<td><code v-pre>c3</code></td>
<td><code v-pre>ret</code></td>
<td><code v-pre>/* return instruction */</code></td>
</tr>
</tbody>
</table>
</li>
...
<li>Intel
<ul>
<li><code v-pre>pop %eax; jmp *%eax</code>
<ol>
