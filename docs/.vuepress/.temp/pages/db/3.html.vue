...
<ul>
<li>데이터베이스 스키마(schema) 정의 수단 제공</li>
</ul>
</li>
<li>DML (Data Manipulation Language, 데이터 조작어)
<ul>
<li>데이터베이스 정보 질의 및 튜플(tuple) 삽입, 삭제, 수정 기능 제공</li>
</ul>
</li>
<li>Integrity (무결성)
<ul>
<li>DDL은 무결성 제약 조건(integrity constraints) 명시 명령어 포함</li>
</ul>
</li>
<li>View definition (뷰 정의)
<ul>
<li>DDL은 뷰(view) 정의 명령어 포함</li>
</ul>
</li>
<li>Transaction control (트랜잭션 제어)
<ul>
<li>트랜잭션(transaction)의 시작과 끝을 명시하는 명령어 포함</li>
</ul>
</li>
<li>Embedded SQL and dynamic SQL (embedded SQL 및 동적 SQL)
<ul>
<li>범용 프로그래밍 언어 내에 SQL 문장을 삽입하는 방법 정의</li>
</ul>
</li>
<li>Authorization (권한 부여)
<ul>
<li>관계(relation) 및 뷰에 대한 접근 권한 명시 명령어 포함</li>
</ul>
</li>
</ul>
...
<ul>
<li>각 관계의 스키마</li>
<li>각 속성(attribute)과 관련된 값의 유형</li>
<li>무결성 제약 조건</li>
<li>각 관계에 대해 유지될 인덱스(index) 집합</li>
<li>각 관계에 대한 보안 및 권한 정보</li>
<li>디스크 상의 각 관계에 대한 물리적 저장 구조</li>
</ul>
</li>
</ul>
...
<li><code v-pre>varchar(n)</code>: 사용자 지정 최대 길이 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>n</mi></mrow><annotation encoding="application/x-tex">n</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal">n</span></span></span></span>의 가변 길이 문자열</li>
<li><code v-pre>int</code>: 정수 (기계에 의존하는 정수의 유한 부분 집합)</li>
<li><code v-pre>smallint</code>: 작은 정수 (정수 도메인 유형의 기계 의존적 부분 집합)</li>
<li><code v-pre>numeric(p,d)</code>: <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>p</mi></mrow><annotation encoding="application/x-tex">p</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.625em;vertical-align:-0.1944em;"></span><span class="mord mathnormal">p</span></span></span></span>자리의 사용자 지정 정밀도와 소수점 이하 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>d</mi></mrow><annotation encoding="application/x-tex">d</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6944em;"></span><span class="mord mathnormal">d</span></span></span></span>자리를 가진 고정 소수점 숫자 (예: <code v-pre>numeric(3,1)</code>은 44.5는 정확히 저장 가능하나, 444.5나 0.32는 불가)</li>
<li><code v-pre>real</code>, <code v-pre>double precision</code>: 기계 의존적 정밀도를 가진 부동 소수점 및 배정밀도 부동 소수점 숫자</li>
...
<ul>
<li><code v-pre>create table r (A1 D1, A2 D2, ..., An Dn, (integrity-constraint1), ..., (integrity-constraintk));</code></li>
</ul>
</li>
<li><span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>r</mi></mrow><annotation encoding="application/x-tex">r</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span></span>은 관계의 이름</li>
<li>각 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><msub><mi>A</mi><mi>i</mi></msub></mrow><annotation encoding="application/x-tex">A_i</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8333em;vertical-align:-0.15em;"></span><span class="mord"><span class="mord mathnormal">A</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.3117em;"><span style="top:-2.55em;margin-left:0em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">i</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span></span></span></span>는 관계 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>r</mi></mrow><annotation encoding="application/x-tex">r</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span></span>의 스키마에 있는 속성 이름</li>
<li><span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><msub><mi>D</mi><mi>i</mi></msub></mrow><annotation encoding="application/x-tex">D_i</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8333em;vertical-align:-0.15em;"></span><span class="mord"><span class="mord mathnormal" style="margin-right:0.02778em;">D</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.3117em;"><span style="top:-2.55em;margin-left:-0.0278em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">i</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span></span></span></span>는 속성 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><msub><mi>A</mi><mi>i</mi></msub></mrow><annotation encoding="application/x-tex">A_i</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8333em;vertical-align:-0.15em;"></span><span class="mord"><span class="mord mathnormal">A</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.3117em;"><span style="top:-2.55em;margin-left:0em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">i</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span></span></span></span>의 도메인(domain)에 있는 값의 데이터 유형</li>
<li>예시:<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">create</span> <span class="token keyword">table</span> instructor<span class="token punctuation">(</span></span>
...
<li>무결성 제약 조건의 유형
<ul>
<li><code v-pre>primary key(A1, ..., An)</code>
<ul>
<li>이 관계의 모든 튜플은 서로 다른 기본 키 값을 가져야 함</li>
<li>위의 Primary-key constraint (기본 키 제약 조건) 강제</li>
</ul>
</li>
<li><code v-pre>foreign key (Am, ..., An) references r</code>
<ul>
<li>Foreign-key constraint (외래 키 제약 조건) 강제</li>
</ul>
</li>
<li><code v-pre>not null</code>
<ul>
<li>이 속성이 NULL 값을 가질 수 없도록 강제</li>
</ul>
</li>
</ul>
</li>
<li>SQL은 무결성 제약 조건을 위반하는 데이터베이스 업데이트 방지</li>
<li>예시:<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">create</span> <span class="token keyword">table</span> instructor<span class="token punctuation">(</span></span>
<span class="line">    ID        <span class="token keyword">char</span><span class="token punctuation">(</span><span class="token number">5</span><span class="token punctuation">)</span><span class="token punctuation">,</span></span>
...
<li>Insert
<ul>
<li><code v-pre>insert into instructor values('10211', 'Smith', 'Biology', 66000);</code></li>
</ul>
</li>
<li>Delete
<ul>
<li><code v-pre>student</code> 관계에서 모든 튜플 제거</li>
<li><code v-pre>delete from student;</code></li>
</ul>
</li>
<li>Drop Table
<ul>
<li><code v-pre>drop table r;</code></li>
</ul>
</li>
<li>Alter
<ul>
<li><code v-pre>alter table r add A D;</code>
<ul>
<li>여기서 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>A</mi></mrow><annotation encoding="application/x-tex">A</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal">A</span></span></span></span>는 관계 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>r</mi></mrow><annotation encoding="application/x-tex">r</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span></span>에 추가될 속성의 이름이고 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>D</mi></mrow><annotation encoding="application/x-tex">D</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">D</span></span></span></span>는 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>A</mi></mrow><annotation encoding="application/x-tex">A</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal">A</span></span></span></span>의 도메인</li>
<li>관계의 모든 기존 튜플은 새 속성에 대해 <code v-pre>null</code> 값으로 할당됨</li>
</ul>
</li>
<li><code v-pre>alter table r drop A;</code>
<ul>
<li>여기서 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>A</mi></mrow><annotation encoding="application/x-tex">A</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal">A</span></span></span></span>는 관계 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>r</mi></mrow><annotation encoding="application/x-tex">r</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span></span>의 속성 이름</li>
<li>속성 삭제는 많은 데이터베이스에서 지원하지 않음</li>
</ul>
</li>
</ul>
</li>
...
<li>일반적인 SQL 질의 형태:
<ul>
<li><code v-pre>select A1, A2, ..., An from r1, r2, ..., rm where P;</code></li>
</ul>
</li>
<li><span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><msub><mi>A</mi><mi>i</mi></msub></mrow><annotation encoding="application/x-tex">A_i</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8333em;vertical-align:-0.15em;"></span><span class="mord"><span class="mord mathnormal">A</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.3117em;"><span style="top:-2.55em;margin-left:0em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">i</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span></span></span></span>는 속성을 나타냄</li>
<li><span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><msub><mi>r</mi><mi>i</mi></msub></mrow><annotation encoding="application/x-tex">r_i</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.5806em;vertical-align:-0.15em;"></span><span class="mord"><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.3117em;"><span style="top:-2.55em;margin-left:-0.0278em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">i</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span></span></span></span>는 관계를 나타냄</li>
<li><span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>P</mi></mrow><annotation encoding="application/x-tex">P</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.13889em;">P</span></span></span></span>는 술어(predicate)</li>
<li>대응하는 관계 대수(relational algebra)<p v-pre class='katex-block'><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><msub><mi mathvariant="normal">Π</mi><mrow><msub><mi>A</mi><mn>1</mn></msub><mo separator="true">,</mo><msub><mi>A</mi><mn>2</mn></msub><mo separator="true">,</mo><mo>…</mo><mo separator="true">,</mo><msub><mi>A</mi><mi>n</mi></msub></mrow></msub><mo stretchy="false">(</mo><mi>σ</mi><mi mathvariant="normal">_</mi><mi>P</mi><mo stretchy="false">(</mo><msub><mi>r</mi><mn>1</mn></msub><mo>×</mo><msub><mi>r</mi><mn>2</mn></msub><mo>×</mo><mo>⋯</mo><mo>×</mo><msub><mi>r</mi><mi>m</mi></msub><mo stretchy="false">)</mo><mo stretchy="false">)</mo></mrow><annotation encoding="application/x-tex">\Pi _{A_1, A_2, \dots, A_n}(\sigma\_P(r_1 \times r_2 \times \dots \times r_m))
...
<li>관계 대수의 프로젝션(projection) 연산에 해당</li>
<li>예시: 모든 강사의 이름 찾기
<ul>
<li><code v-pre>select name from instructor;</code></li>
</ul>
</li>
<li>참고: SQL 이름은 대소문자를 구분하지 않음 (예: <code v-pre>Name</code> <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mo>≡</mo></mrow><annotation encoding="application/x-tex">\equiv</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4637em;"></span><span class="mrel">≡</span></span></span></span> <code v-pre>NAME</code> <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mo>≡</mo></mrow><annotation encoding="application/x-tex">\equiv</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4637em;"></span><span class="mrel">≡</span></span></span></span> <code v-pre>name</code>)</li>
<li>SQL은 관계뿐만 아니라 질의 결과에서도 중복을 허용</li>
<li>중복 제거를 강제하려면 <code v-pre>select</code> 뒤에 <code v-pre>distinct</code> 키워드 삽입
<ul>
<li>모든 강사의 학과 이름을 찾고 중복 제거</li>
<li><code v-pre>select distinct dept_name from instructor;</code></li>
</ul>
</li>
<li><code v-pre>all</code> 키워드는 중복이 제거되지 않아야 함을 명시
<ul>
<li><code v-pre>select all dept_name from instructor;</code></li>
</ul>
</li>
<li><code v-pre>select</code> 절의 별표(<code v-pre>*</code>)는 &quot;모든 속성&quot;을 의미
<ul>
<li><code v-pre>select * from instructor;</code></li>
<li><code v-pre>select instructor.* from instructor, teaches;</code></li>
</ul>
</li>
<li>속성은 <code v-pre>from</code> 절 없이 리터럴(literal)이 될 수 있음
<ul>
<li><code v-pre>select '437';</code></li>
<li>결과는 &quot;437&quot; 값을 가진 단일 행과 하나의 열을 가진 테이블</li>
</ul>
</li>
<li>다음을 사용하여 열에 이름 부여 가능:
<ul>
<li><code v-pre>select '437' as FOO;</code></li>
</ul>
</li>
<li>속성은 <code v-pre>from</code> 절과 함께 리터럴이 될 수 있음
<ul>
<li><code v-pre>select 'A' from instructor;</code></li>
<li>결과는 하나의 열과 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>N</mi></mrow><annotation encoding="application/x-tex">N</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.10903em;">N</span></span></span></span>개의 행(<code v-pre>instructor</code> 테이블의 튜플 수)을 가진 테이블이며, 각 행의 값은 &quot;A&quot;</li>
</ul>
</li>
<li><code v-pre>select</code> 절은 <code v-pre>+</code>, <code v-pre>-</code>, <code v-pre>*</code>, <code v-pre>/</code> 연산을 포함하는 산술 표현식을 포함할 수 있으며, 상수 또는 튜플의 속성에 대해 연산</li>
<li>질의: <code v-pre>select ID, name, dept_name, salary/12 from instructor;</code>
<ul>
<li><code v-pre>instructor</code> 관계와 동일하지만 <code v-pre>salary</code> 속성 값이 12로 나누어진 관계를 반환</li>
<li>일반화된 프로젝션 연산에 해당</li>
</ul>
</li>
<li><code v-pre>as</code> 절을 사용하여 &quot;salary/12&quot;의 이름 변경 가능:
<ul>
<li><code v-pre>select ID, name, dept_name, salary/12 as monthly_salary;</code></li>
</ul>
</li>
</ul>
...
<li>관계 대수의 선택(selection) 술어에 해당</li>
<li>컴퓨터 공학(Comp. Sci.)과의 모든 강사 찾기
<ul>
<li><code v-pre>select name from instructor where dept_name = 'Comp. Sci.';</code></li>
</ul>
</li>
<li>SQL은 논리적 연결사 <code v-pre>and</code>, <code v-pre>or</code>, <code v-pre>not</code> 사용을 허용</li>
<li>논리적 연결사의 피연산자는 비교 연산자 <code v-pre>&lt;</code>, <code v-pre>&lt;=</code>, <code v-pre>&gt;</code>, <code v-pre>&gt;=</code>, <code v-pre>=</code>, <code v-pre>&lt;&gt;</code>를 포함하는 표현식이 될 수 있음</li>
<li>비교는 산술 표현식의 결과에 적용 가능</li>
<li>급여가 70000보다 큰 컴퓨터 공학과의 모든 강사 찾기
<ul>
<li><code v-pre>select name from instructor where dept_name = 'Comp. Sci.' and salary &gt; 70000;</code></li>
</ul>
</li>
</ul>
...
<li>관계 대수의 카티전 프로덕트(Cartesian product) 연산에 해당</li>
<li><code v-pre>instructor</code> <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mo>×</mo></mrow><annotation encoding="application/x-tex">\times</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6667em;vertical-align:-0.0833em;"></span><span class="mord">×</span></span></span></span> <code v-pre>teaches</code>의 카티전 프로덕트 찾기
<ul>
<li><code v-pre>select * from instructor, teaches;</code></li>
</ul>
</li>
<li>가능한 모든 <code v-pre>instructor-teaches</code> 쌍을 생성하며, 두 관계의 모든 속성을 포함</li>
...
<ul>
<li><code v-pre>select name, course_id from instructor, teaches where instructor.ID = teaches.ID;</code></li>
</ul>
</li>
<li>예술(Art) 학과에서 어떤 과목을 가르친 모든 강사의 이름과 <code v-pre>course_id</code> 찾기
<ul>
<li><code v-pre>select name, course_id from instructor, teaches where instructor.ID = teaches.ID and instructor.dept_name = 'Art';</code></li>
</ul>
</li>
<li>SQL은 중복을 허용함</li>
</ul>
...
<ul>
<li><code v-pre>old-name as new-name</code></li>
</ul>
</li>
<li>만약 <code v-pre>new-name</code>이 속성이 아닌 관계를 위한 것이라면, '상관 이름(correlation name)'(SQL 표준), '테이블 별칭(table alias)', '상관 변수(correlation variable)' 또는 '튜플 변수(tuple variable)'라고 불림</li>
<li>'Comp. Sci.'에 있는 어떤 강사보다 높은 급여를 받는 모든 강사의 이름 찾기:
<ul>
<li><code v-pre>select distinct T.name from instructor as T, instructor as S where T.salary &gt; S.salary and S.dept_name = 'Comp. Sci.';</code></li>
</ul>
</li>
...
<ul>
<li>퍼센트 (<code v-pre>%</code>): 모든 하위 문자열과 일치</li>
<li>밑줄 (<code v-pre>_</code>): 모든 단일 문자와 일치</li>
</ul>
</li>
<li>이름에 &quot;dar&quot; 하위 문자열을 포함하는 모든 강사의 이름 찾기
<ul>
<li><code v-pre>select name from instructor where name like '%dar%';</code></li>
</ul>
</li>
<li>문자열 &quot;100%&quot;와 일치시키기
<ul>
<li><code v-pre>like '100\%' escape '\'</code></li>
<li>위 예시에서 백슬래시(<code v-pre>\</code>)를 이스케이프 문자로 사용 (다른 어떤 문자도 이스케이프 문자로 사용 가능)</li>
</ul>
</li>
<li>패턴은 대소문자를 구분</li>
<li>패턴 매칭 예시:
<ul>
<li><code v-pre>'Intro%'</code>: &quot;Intro&quot;로 시작하는 모든 문자열과 일치</li>
<li><code v-pre>'%Comp%'</code>: &quot;Comp&quot;를 하위 문자열로 포함하는 모든 문자열과 일치</li>
<li><code v-pre>'_ _ _'</code>: 정확히 세 문자로 된 모든 문자열과 일치</li>
<li><code v-pre>'_ _ _ %'</code>: 최소 세 문자로 된 모든 문자열과 일치</li>
</ul>
</li>
<li>SQL은 다양한 문자열 연산 지원
<ul>
<li>연결 (<code v-pre>||</code> 사용)</li>
<li>대소문자 변환</li>
<li>문자열 길이 찾기, 하위 문자열 추출 등</li>
</ul>
</li>
</ul>
...
<ul>
<li><code v-pre>select distinct name from instructor order by name;</code></li>
</ul>
</li>
<li>각 속성에 대해 내림차순은 <code v-pre>desc</code>, 오름차순은 <code v-pre>asc</code>를 명시 가능하며, 오름차순이 기본값
<ul>
<li>예시: <code v-pre>order by name desc</code></li>
</ul>
</li>
<li>여러 속성에 대해 정렬 가능
<ul>
<li>예시: <code v-pre>order by dept_name desc, name asc</code></li>
</ul>
</li>
</ul>
...
<li>예시: 급여가 $90,000에서 $100,000 사이인 모든 강사의 이름 찾기 (즉, <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mo>≥</mo></mrow><annotation encoding="application/x-tex">\ge</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.7719em;vertical-align:-0.136em;"></span><span class="mrel">≥</span></span></span></span> $90,000 이고 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mo>≤</mo></mrow><annotation encoding="application/x-tex">\le</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.7719em;vertical-align:-0.136em;"></span><span class="mrel">≤</span></span></span></span> <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mn>100</mn><mo separator="true">,</mo><mn>000</mn></mrow><annotation encoding="application/x-tex">100,000</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8389em;vertical-align:-0.1944em;"></span><span class="mord">100</span><span class="mpunct">,</span><span class="mspace" style="margin-right:0.1667em;"></span><span class="mord">000</span></span></span></span>)
<ul>
<li><code v-pre>select name from instructor where salary between 90000 and 100000;</code></li>
</ul>
</li>
<li>튜플 비교
<ul>
<li><code v-pre>select name, course_id from instructor, teaches where (instructor.ID, dept_name) = (teaches.ID, 'Biology');</code></li>
</ul>
</li>
<li>위는 아래와 동일
<ul>
<li><code v-pre>select name, course_id from instructor, teaches where instructor.ID = teaches.ID and dept_name = 'Biology';</code></li>
</ul>
</li>
</ul>
...
<li>각 연산은 자동으로 중복을 제거</li>
<li>모든 중복을 유지하려면 <code v-pre>union all</code> (또는 <code v-pre>intersect all</code> 혹은 <code v-pre>except all</code>) 사용</li>
<li>2017년 가을 또는 2018년 봄에 개설된 과목 찾기
<ul>
<li><code v-pre>(select course_id from section where sem = 'Fall' and year = 2017) union (select course_id from section where sem = 'Spring' and year = 2018);</code></li>
</ul>
</li>
<li>2017년 가을과 2018년 봄에 모두 개설된 과목 찾기
<ul>
<li><code v-pre>(select course_id from section where sem = 'Fall' and year = 2017) intersect (select course_id from section where sem = 'Spring' and year = 2018);</code></li>
</ul>
</li>
<li>2017년 가을에는 개설되었지만 2018년 봄에는 개설되지 않은 과목 찾기
<ul>
<li><code v-pre>(select course_id from section where sem = 'Fall' and year = 2017) except (select course_id from section where sem = 'Spring' and year = 2018);</code></li>
</ul>
</li>
</ul>
...
<ul>
<li><code v-pre>avg</code>: 평균값 (숫자 값에만 해당)</li>
<li><code v-pre>min</code>: 최솟값 (숫자 및 비숫자 값 모두 해당)</li>
<li><code v-pre>max</code>: 최댓값 (숫자 및 비숫자 값 모두 해당)</li>
<li><code v-pre>sum</code>: 값의 합계 (숫자 값에만 해당)</li>
<li><code v-pre>count</code>: 값의 개수 (숫자 및 비숫자 값 모두 해당)</li>
</ul>
</li>
<li>SQL에서 <code v-pre>count</code>를 제외한 집계 함수(aggregate functions)는 <code v-pre>null</code> 값을 무시</li>
<li><code v-pre>null</code> 값이 무시된 결과로 값들의 컬렉션이 비어 있을 수 있음</li>
...
<ul>
<li><code v-pre>select avg(salary) from instructor where dept_name = 'Comp. Sci.';</code></li>
</ul>
</li>
<li>2018년 봄 학기에 과목을 가르치는 총 강사 수 찾기
<ul>
<li><code v-pre>select count(distinct ID) from teaches where semester = 'Spring' and year = 2018;</code></li>
</ul>
</li>
<li><code v-pre>course</code> 관계의 튜플 수 찾기
<ul>
<li><code v-pre>select count(*) from course;</code></li>
</ul>
</li>
</ul>
...
<li>각 학과의 강사 평균 급여 찾기
<ul>
<li><code v-pre>select dept_name, avg(salary) as avg_salary from instructor group by dept_name;</code></li>
</ul>
</li>
...
<ul>
<li><code v-pre>/* erroneous query */</code></li>
<li><code v-pre>select dept_name, ID, avg(salary) from instructor group by dept_name;</code></li>
</ul>
</li>
...
<li><code v-pre>having</code> 절의 술어는 그룹 형성 후에 적용되는 반면, <code v-pre>where</code> 절의 술어는 그룹 형성 전에 적용됨</li>
<li>평균 급여가 42000보다 큰 모든 학과의 이름과 평균 급여 찾기<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">select</span> dept_name<span class="token punctuation">,</span> <span class="token function">avg</span><span class="token punctuation">(</span>salary<span class="token punctuation">)</span> <span class="token keyword">as</span> avg_salary</span>
...
<li>평가 순서
<ol>
<li><code v-pre>from</code> 절이 먼저 평가됨</li>
<li><code v-pre>where</code> 절의 술어(존재 시)가 <code v-pre>from</code> 절의 결과에 적용됨</li>
<li><code v-pre>where</code> 술어를 만족하는 튜플들이 <code v-pre>group by</code> 절에 의해 그룹으로 배치됨</li>
<li><code v-pre>having</code> 절(존재 시)이 각 그룹에 적용됨; <code v-pre>having</code> 절 술어를 만족하지 않는 그룹들은 제거됨</li>
<li><code v-pre>select</code> 절은 남은 그룹들을 사용하여, 집계 함수(존재 시)를 적용한 후 각 그룹에 대한 단일 결과 튜플을 얻음</li>
</ol>
</li>
</ul>
...
<li>서브쿼리는 다른 쿼리 내에 중첩된 <code v-pre>select-from-where</code> 표현식</li>
<li>중첩은 다음 SQL 쿼리에서 수행될 수 있음: <code v-pre>select A1, A2, ..., An from r1, r2, ..., rm where P</code></li>
<li>다음과 같이:
<ul>
<li><code v-pre>from</code> 절: <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><msub><mi>r</mi><mi>i</mi></msub></mrow><annotation encoding="application/x-tex">r_i</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.5806em;vertical-align:-0.15em;"></span><span class="mord"><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.3117em;"><span style="top:-2.55em;margin-left:-0.0278em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">i</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span></span></span></span>는 유효한 서브쿼리로 대체 가능</li>
<li><code v-pre>where</code> 절: <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>P</mi></mrow><annotation encoding="application/x-tex">P</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.13889em;">P</span></span></span></span>는 <code v-pre>B &lt;operation&gt; (subquery)</code> 형태의 표현식으로 대체 가능. 여기서 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>B</mi></mrow><annotation encoding="application/x-tex">B</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.05017em;">B</span></span></span></span>는 속성</li>
<li><code v-pre>select</code> 절: <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><msub><mi>A</mi><mi>i</mi></msub></mrow><annotation encoding="application/x-tex">A_i</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8333em;vertical-align:-0.15em;"></span><span class="mord"><span class="mord mathnormal">A</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.3117em;"><span style="top:-2.55em;margin-left:0em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">i</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span></span></span></span>는 단일 값을 생성하는 서브쿼리(스칼라 서브쿼리, scalar subquery)로 대체 가능</li>
</ul>
</li>
</ul>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>2017년 가을에는 제공되었지만 2018년 봄에는 제공되지 않은 과목 찾기<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">select</span> <span class="token keyword">distinct</span> course_id</span>
<span class="line"><span class="token keyword">from</span> section</span>
<span class="line"><span class="token keyword">where</span> semester <span class="token operator">=</span> <span class="token string">'Fall'</span> <span class="token operator">and</span> <span class="token keyword">year</span> <span class="token operator">=</span> <span class="token number">2017</span> <span class="token operator">and</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>이름이 &quot;Mozart&quot;도 &quot;Einstein&quot;도 아닌 모든 강사 이름 지정
<ul>
<li><code v-pre>select distinct name from instructor where name not in ('Mozart', 'Einstein');</code></li>
</ul>
</li>
<li>ID가 10101인 강사가 가르친 과목 섹션을 수강한 (고유한) 학생들의 총 수 찾기<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">select</span> <span class="token function">count</span><span class="token punctuation">(</span><span class="token keyword">distinct</span> ID<span class="token punctuation">)</span></span>
...
<li>참고: 위 쿼리는 훨씬 간단한 방식으로 작성 가능하며, 위 공식은 SQL 기능 설명 목적임</li>
</ul>
</li>
</ul>
...
<ul>
<li><code v-pre>select distinct T.name from instructor as T, instructor as S where T.salary &gt; S.salary and S.dept_name = 'Biology';</code></li>
</ul>
</li>
<li><code v-pre>some</code> 절을 사용한 동일한 쿼리
<ul>
<li><code v-pre>select name from instructor where salary &gt; some (select salary from instructor where dept_name = 'Biology');</code></li>
</ul>
</li>
</ul>
...
<li>여기서 <code v-pre>&lt;comp&gt;</code>는 <code v-pre>&lt;</code>, <code v-pre>&lt;=</code>, <code v-pre>&gt;</code>, <code v-pre>=</code>, <code v-pre>!=</code>가 될 수 있음</li>
<li><code v-pre> (5 &lt; some {0, 5, 6})</code> = <code v-pre>true</code></li>
<li><code v-pre> (5 &lt; some {0, 5, 0})</code> = <code v-pre>false</code></li>
<li><code v-pre> (5 = some {0, 5, 0})</code> = <code v-pre>true</code></li>
<li><code v-pre> (5 != some {0, 5, 5})</code> = <code v-pre>true</code> (∵ <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mn>0</mn><mo mathvariant="normal">≠</mo><mn>5</mn></mrow><annotation encoding="application/x-tex">0 \ne 5</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord">0</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel"><span class="mrel"><span class="mord vbox"><span class="thinbox"><span class="rlap"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="inner"><span class="mord"><span class="mrel"></span></span></span><span class="fix"></span></span></span></span></span><span class="mrel">=</span></span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.6444em;"></span><span class="mord">5</span></span></span></span>)</li>
...
<ul>
<li><code v-pre>select name from instructor where salary &gt; all (select salary from instructor where dept_name = 'Biology');</code></li>
</ul>
</li>
</ul>
...
<li><code v-pre> (5 &lt; all {0, 5, 6})</code> = <code v-pre>false</code></li>
<li><code v-pre> (5 &lt; all {6, 10, 4})</code> = <code v-pre>false</code></li>
<li><code v-pre> (5 = all {4, 5, 6})</code> = <code v-pre>false</code></li>
<li><code v-pre> (5 != all {4, 6})</code> = <code v-pre>true</code> (∵ <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mn>5</mn><mo mathvariant="normal">≠</mo><mn>4</mn></mrow><annotation encoding="application/x-tex">5 \ne 4</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord">5</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel"><span class="mrel"><span class="mord vbox"><span class="thinbox"><span class="rlap"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="inner"><span class="mord"><span class="mrel"></span></span></span><span class="fix"></span></span></span></span></span><span class="mrel">=</span></span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.6444em;"></span><span class="mord">4</span></span></span></span> 이고 <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mn>5</mn><mo mathvariant="normal">≠</mo><mn>6</mn></mrow><annotation encoding="application/x-tex">5 \ne 6</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord">5</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel"><span class="mrel"><span class="mord vbox"><span class="thinbox"><span class="rlap"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="inner"><span class="mord"><span class="mrel"></span></span></span><span class="fix"></span></span></span></span></span><span class="mrel">=</span></span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.6444em;"></span><span class="mord">6</span></span></span></span>)</li>
...
<li><code v-pre>exists r</code> <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mo>⇔</mo><mi>r</mi><mo mathvariant="normal">≠</mo><mi mathvariant="normal">∅</mi></mrow><annotation encoding="application/x-tex">\Leftrightarrow r \ne \emptyset</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.3669em;"></span><span class="mrel">⇔</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel"><span class="mrel"><span class="mord vbox"><span class="thinbox"><span class="rlap"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="inner"><span class="mord"><span class="mrel"></span></span></span><span class="fix"></span></span></span></span></span><span class="mrel">=</span></span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.8056em;vertical-align:-0.0556em;"></span><span class="mord">∅</span></span></span></span></li>
<li><code v-pre>not exists r</code> <span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mo>⇔</mo><mi>r</mi><mo>=</mo><mi mathvariant="normal">∅</mi></mrow><annotation encoding="application/x-tex">\Leftrightarrow r = \emptyset</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.3669em;"></span><span class="mrel">⇔</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.8056em;vertical-align:-0.0556em;"></span><span class="mord">∅</span></span></span></span></li>
<li>&quot;2017년 가을 학기와 2018년 봄 학기 모두에 가르친 모든 과목 찾기&quot; 쿼리를 지정하는 또 다른 방법<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">select</span> course_id</span>
...
<li>주어진 서브쿼리에 중복이 없으면 <code v-pre>true</code>로 평가됨</li>
<li>2017년에 최대 한 번 제공된 모든 과목 찾기<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">select</span> T<span class="token punctuation">.</span>course_id</span>
...
<li>평균 급여가 $42,000 이상인 학과들의 강사 평균 급여 찾기<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">select</span> dept_name<span class="token punctuation">,</span> avg_salary</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li><code v-pre>having</code> 절을 사용할 필요가 없다는 점에 유의</li>
<li>위 쿼리를 작성하는 또 다른 방법<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">select</span> dept_name<span class="token punctuation">,</span> avg_salary</span>
...
<li>평균 예산보다 더 큰 예산을 가진 모든 학과 찾기<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">with</span> avg_budget<span class="token punctuation">(</span><span class="token keyword">value</span><span class="token punctuation">)</span> <span class="token keyword">as</span></span>
...
<li>스칼라 서브쿼리는 외부 쿼리의 <code v-pre>select</code> 절에서 사용될 수 있음</li>
<li>각 학과의 강사 수와 함께 모든 학과 나열<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">select</span> dept_name<span class="token punctuation">,</span></span>
...
<li><code v-pre>null</code>은 알 수 없는 값이거나 값이 존재하지 않음을 의미</li>
<li><code v-pre>null</code>을 포함하는 모든 산술 표현식의 결과는 <code v-pre>null</code></li>
<li>집계 함수는 <code v-pre>null</code> 값을 무시</li>
<li>중복 제거 및 그룹화의 경우, <code v-pre>null</code>은 다른 값처럼 취급되며, 두 <code v-pre>null</code>은 동일한 것으로 간주됨</li>
<li><code v-pre>is null</code> 술어는 <code v-pre>null</code> 값을 확인하는 데 사용될 수 있음</li>
<li>예시: 급여가 <code v-pre>null</code>인 모든 강사 찾기
<ul>
<li><code v-pre>select name from instructor where salary is null;</code></li>
</ul>
</li>
<li><code v-pre>is not null</code> 술어는 적용된 값이 <code v-pre>null</code>이 아닌 경우 성공</li>
<li>SQL은 <code v-pre>null</code> 값을 포함하는 비교의 결과를 <code v-pre>unknown</code>으로 처리 (<code v-pre>is null</code> 및 <code v-pre>is not null</code> 술어 제외)</li>
<li>예시: <code v-pre>5 &lt; null</code> 또는 <code v-pre>null &lt;&gt; null</code> 또는 <code v-pre>null = null</code></li>
<li><code v-pre>where</code> 절의 술어는 불리언(boolean) 연산(<code v-pre>and</code>, <code v-pre>or</code>, <code v-pre>not</code>)을 포함할 수 있으므로, <code v-pre>unknown</code> 값을 처리하기 위해 불리언 연산의 정의를 확장해야 함
<ul>
<li><code v-pre>and</code>: <code v-pre>(true and unknown)</code> = <code v-pre>unknown</code>, <code v-pre>(false and unknown)</code> = <code v-pre>false</code>, <code v-pre>(unknown and unknown)</code> = <code v-pre>unknown</code></li>
<li><code v-pre>or</code>: <code v-pre>(unknown or true)</code> = <code v-pre>true</code>, <code v-pre>(unknown or false)</code> = <code v-pre>unknown</code>, <code v-pre>(unknown or unknown)</code> = <code v-pre>unknown</code></li>
<li><code v-pre>not</code>: <code v-pre>(not unknown)</code> = <code v-pre>unknown</code></li>
</ul>
</li>
...
<li>모든 강사 삭제
<ul>
<li><code v-pre>delete from instructor;</code></li>
</ul>
</li>
<li>재무(Finance) 학과의 모든 강사 삭제
<ul>
<li><code v-pre>delete from instructor where dept_name = 'Finance';</code></li>
</ul>
</li>
<li><code v-pre>'ITBT'</code> 건물에 위치한 학과와 관련된 <code v-pre>instructor</code> 관계의 모든 튜플 삭제
<ul>
<li><code v-pre>delete from instructor where dept_name in (select dept_name from department where building = 'ITBT');</code></li>
</ul>
</li>
<li>급여가 강사 평균 급여보다 적은 모든 강사 삭제
<ul>
<li>문제점: <code v-pre>instructor</code>에서 튜플을 삭제함에 따라 평균 급여가 변경됨</li>
<li>SQL의 해결책:
<ol>
<li>먼저 <code v-pre>avg(salary)</code>를 계산하고 삭제할 모든 튜플을 찾음</li>
<li>위에서 찾은 모든 튜플을 삭제 (평균을 재계산하거나 튜플을 다시 테스트하지 않음)</li>
</ol>
</li>
</ul>
<!-- end list -->
<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">delete</span> <span class="token keyword">from</span> instructor</span>
...
<ul>
<li><code v-pre>insert into course values ('CS-437', 'Database Systems', 'Comp. Sci.', 4);</code></li>
</ul>
</li>
<li>또는 동등하게
<ul>
<li><code v-pre>insert into course (course_id, title, dept_name, credits) values ('CS-437', 'Database Systems', 'Comp. Sci.', 4);</code></li>
</ul>
</li>
<li><code v-pre>tot_creds</code>가 <code v-pre>null</code>로 설정된 새 튜플을 <code v-pre>student</code>에 추가
<ul>
<li><code v-pre>insert into student values ('3003', 'Green', 'Finance', null);</code></li>
</ul>
</li>
<li>144 학점 이상을 이수한 음악(Music) 학과의 각 학생을 급여 $18,000의 음악 학과 강사로 만듦
<ul>
<li><code v-pre>insert into instructor select ID, name, dept_name, 18000 from student where dept_name = 'Music' and total_cred &gt; 144;</code></li>
</ul>
</li>
<li><code v-pre>student</code> 관계의 스키마: <code v-pre>(ID, name, dept_name, tot_cred)</code></li>
...
<li>모든 강사에게 5% 급여 인상
<ul>
<li><code v-pre>update instructor set salary = salary * 1.05;</code></li>
</ul>
</li>
<li>70000 미만을 버는 강사에게 5% 급여 인상
<ul>
<li><code v-pre>update instructor set salary = salary * 1.05 where salary &lt; 70000;</code></li>
</ul>
</li>
<li>평균보다 급여가 적은 강사에게 5% 급여 인상
<ul>
<li><code v-pre>update instructor set salary = salary * 1.05 where salary &lt; (select avg(salary) from instructor);</code></li>
</ul>
</li>
<li>급여가 $100,000 이상인 강사의 급여를 3% 인상하고, 나머지는 5% 인상</li>
<li>두 개의 <code v-pre>update</code> 문 작성 (순서가 중요함):<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">update</span> instructor <span class="token keyword">set</span> salary <span class="token operator">=</span> salary <span class="token operator">*</span> <span class="token number">1.03</span> <span class="token keyword">where</span> salary <span class="token operator">></span> <span class="token number">100000</span><span class="token punctuation">;</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li><code v-pre>case</code> 문을 사용한 더 나은 방법:<div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql"><pre v-pre><code class="language-sql"><span class="line"><span class="token keyword">update</span> instructor</span>
