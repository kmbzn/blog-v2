...
<p>Gmail, Meet, Chat, Drive, Docs, Sheets, Slides — 이 모든 앱의 아이콘이 동일한 4가지 색을 서로 다른 배치로 쪼개 담은 형태가 되었다. 배경색도 유사했고, 크기를 줄이면 구분이 사실상 불가능했다. 16×16px 파비콘(favicon) 크기에서는 네 가지 색 덩어리로 붕괴되어, 브라우저 탭을 구분하려면 아이콘을 &quot;읽어야&quot; 했다.</p>
