...
<li>예금자보호 여부: <strong>보호 (1인 1금융기관 기준 최대 5,000만원)</strong></li>
...
<ul>
<li>예금자보호 적용 (최대 5,000만원)</li>
<li>체크카드, 자동이체 등 은행 서비스와 연동 가능</li>
<li>입출금이 즉시 처리됨</li>
</ul>
...
<tr>
<td>RP형</td>
<td>증권사가 보유한 국채·공사채 등을 담보로 운용</td>
<td>가장 일반적, 금리 비교적 높음</td>
</tr>
<tr>
<td>MMF형</td>
<td>단기 채권 펀드에 투자</td>
<td>원금 손실 가능성 매우 낮음 (극히 드뭄)</td>
</tr>
<tr>
<td>발행어음형</td>
<td>증권사가 자체 발행한 어음</td>
<td>높은 금리, 단 예금자보호 미적용</td>
</tr>
<tr>
<td>종금형</td>
<td>종합금융회사 운영 (현재 극소수)</td>
<td>예금자보호 적용 (5,000만원)</td>
</tr>
</tbody>
</table>
...
<li>예금자보호 여부: <strong>대부분 미적용</strong> (종금형 제외)</li>
<li>이자 계산: 일별 복리 지급 (일부 상품은 매일 이자 지급)</li>
...
<p><strong>장점</strong></p>
<ul>
<li>파킹통장 대비 금리가 높은 경우가 많음</li>
<li>주식·ETF 투자와 연동해서 쓰기 편리</li>
<li>매일 이자가 들어오는 상품도 있어 복리 효과</li>
</ul>
<p><strong>단점</strong></p>
<ul>
...
<tr>
<td>예금자보호</td>
<td><strong>적용 (최대 5,000만원)</strong></td>
<td>대부분 미적용</td>
</tr>
<tr>
<td>금리 수준</td>
...
<li>공과금 자동이체, 월급 계좌와 연동이 필요한 경우</li>
<li>5,000만원 이하의 단기 자금 보관</li>
...
<p>5,000만원 이하 단기 자금이라면 <strong>파킹통장</strong>이 안정적이다. 금리 차이(0.5~1%p)가 있지만, 예금자보호가 주는 안전성은 그 이상의 가치가 있다.</p>
<p>5,000만원 초과 여유 자금이라면 어차피 예금자보호를 초과하므로, CMA의 높은 금리를 선택하거나 두 상품을 분산해서 사용하는 것이 현명하다.</p>
<div class="hint-container info">
<p class="hint-container-title">금리 변동 주의</p>
<p>파킹통장과 CMA 금리는 한국은행 기준금리에 연동해 변동한다. 기준금리 인하 시 두 상품 모두 금리가 내려가므로, 현재 공시 금리가 미래에도 유지된다고 보장할 수 없다.</p>
</div>
<div class="hint-container warning">
<p class="hint-container-title">예금자보호 한도</p>
<p>예금자보호는 1인 1금융기관(은행) 기준 원금+이자 합산 <strong>5,000만원</strong>까지 보호한다. 2개 이상의 은행에 나눠 예치하면 각 은행별로 5,000만원까지 보호받는다. 증권사 RP형 CMA는 예금자보호 대상이 아니다.</p>
</div>
</div></template>
