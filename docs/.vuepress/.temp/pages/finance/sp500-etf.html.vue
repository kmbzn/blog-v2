...
<ul>
<li>달러가 강세(원화 약세)면 → 환차익 추가 발생</li>
<li>달러가 약세(원화 강세)면 → 환차손 발생</li>
</ul>
<p><strong>장기 투자 관점</strong>에서는 일반적으로 환노출이 권장된다. 이유:</p>
<ol>
<li>환헷지 비용(헷지 프리미엄)이 연 0.5~1.5% 수준으로 장기 수익을 갉아먹는다</li>
...
<ul>
<li>환율 변동에 관계없이 지수 성과만 추구</li>
<li>헷지 비용이 발생 (국내 금리 - 미국 금리 차이에 비례)</li>
<li>2022~2024년처럼 미국 금리가 한국보다 높은 시기에는 헷지 비용이 오히려 크게 증가</li>
</ul>
...
<ol>
<li>증권사 앱에서 계좌 개설 (비대면 가능)</li>
<li>ISA, 연금저축펀드, IRP 중 하나 선택 (아래 세금 혜택 참고)</li>
<li>티커 검색 (예: <code v-pre>360750</code> 또는 <code v-pre>TIGER 미국S&amp;P500</code>)</li>
...
<p><strong>절차</strong></p>
<ol>
<li>해외주식 가능 증권사 선택 (삼성증권, 키움증권, 미래에셋증권 등)</li>
<li>해외주식 계좌 개설</li>
<li>원화 → 달러 환전 (증권사마다 환전 수수료 다름; 이벤트 시 0원 가능)</li>
<li>영문 티커로 검색 (VOO, IVV, SPY)</li>
<li>매수</li>
</ol>
...
<li>납입액의 13.2~16.5% 세액공제 (연봉 5,500만원 이하 16.5%, 초과 13.2%)</li>
<li>수익에 대한 세금은 55세 이후 수령 시 3.3~5.5% 연금소득세로 이연</li>
...
<li><strong>인출 자제</strong>: 적립식의 핵심은 시장이 하락해도 매도하지 않는 것. 하락장에서 저가 매수가 이루어지므로 오히려 유리하다</li>
...
<li>[ ] 비상금(생활비 3~6개월)은 별도로 확보되어 있는가?</li>
<li>[ ] ISA 또는 연금저축 계좌를 활용하고 있는가?</li>
<li>[ ] 환노출 vs 환헷지 중 본인 상황에 맞는 쪽을 선택했는가?</li>
<li>[ ] 시장 하락 시에도 매도하지 않을 수 있는가?</li>
</ul>
