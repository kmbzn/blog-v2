<template><div><h1 id="kmbzn-com" tabindex="-1"><a class="header-anchor" href="#kmbzn-com"><span>kmbzn.com</span></a></h1>
<blockquote>
<p><em>본 blog는 다양한 주제에 대한 저의 관심과 생각을 체계적으로 정리하고 공유하는 공간입니다.</em><br>
<em>CS, tech, design, finance 등 여러 분야에 걸쳐 자유롭게 기록하고 있습니다.</em></p>
</blockquote>
<p><img src="https://kmbzn.com/images/profile.jpg" alt="Profile Image"><br>
<em>Welcome to my personal blog...</em></p>
...
<tr>
<td>GitHub</td>
<td><a href="https://github.com/kmbzn" target="_blank" rel="noopener noreferrer">github.com/kmbzn</a></td>
</tr>
<tr>
<td>IG</td>
<td><a href="https://instagram.com/kmbzn" target="_blank" rel="noopener noreferrer">@kmbzn</a></td>
</tr>
<tr>
<td>Univ.</td>
<td><em>Hanyang Univ.</em> (Class of '21)</td>
</tr>
<tr>
<td>Major</td>
<td><em>Dept. of</em> Computer Science</td>
</tr>
<tr>
<td>HS</td>
<td><em>Joongdong High,</em> 112th</td>
</tr>
</tbody>
</table>
...
<li>프로그래밍 언어 및 도구: Python, C, C++, Java, Git</li>
<li>알고리즘 문제 풀이: 온라인 저지 기반 학습</li>
<li>Computer graphics: rendering, transformation matrix, lighting model, OpenGL</li>
</ul>
...
<ul>
<li>Watch industry: 브랜드, movement 구조, 디자인, 스타일, 착용 경험 등</li>
<li>금융 및 자산 투자: Bitcoin, crypto, blockchain, 미국 주식, 국내 주식 등</li>
...
<blockquote>
<p>전공 기반의 기술적 분석부터 시각적 표현, 실생활의 경험, 인문학적 관점까지 다양한 관심사를 자유롭게 정리하고 공유하는 공간입니다.</p>
</blockquote>
...
<p>If you'd like to create your own blog based on this one:</p>
<ol>
<li>
<p>Go to the repository: <a href="https://github.com/kmbzn/blog" target="_blank" rel="noopener noreferrer">github.com/kmbzn/blog</a></p>
</li>
<li>
<p>Click the <strong>Fork</strong> button at the top-right of the page.</p>
</li>
<li>
...
<li>
<p>Customize the content under <code v-pre>docs/</code> and <code v-pre>.vuepress/</code> as you like.</p>
</li>
<li>
<p>Deploy it via GitHub Pages or your preferred static hosting.</p>
</li>
</ol>
<blockquote>
<p>This blog uses <a href="https://vuepress.vuejs.org/" target="_blank" rel="noopener noreferrer">VuePress</a> for static site generation. Make sure you have Node.js installed.</p>
</blockquote>
...
<li><strong>However, all blog posts and resources are NOT licensed for commercial use.</strong>
<ul>
<li>Do not reproduce, redistribute, or use them for profit without explicit permission.</li>
</ul>
</li>
</ul>
<p>If you wish to use any part of the content commercially, please contact me via GitHub Issues or email.</p>
<p>For full MIT License terms, refer to the <a href="https://github.com/kmbzn/blog/blob/master/LICENSE" target="_blank" rel="noopener noreferrer"><code v-pre>LICENSE</code></a> file in the repository.</p>
<Home/></div></template>
