...
<h1 id="contiguous-allocation-cont" tabindex="-1"><a class="header-anchor" href="#contiguous-allocation-cont"><span>Contiguous Allocation (Cont.)</span></a></h1>
<ul>
...
<p>기본 방식</p>
<ul>
<li>물리 메모리를 <strong>고정 크기 블록(frame)</strong> 으로 나눔<br>
(크기는 2의 제곱수, 512B ~ 8MB)</li>
<li>논리 메모리를 <strong>같은 크기의 블록(page)</strong> 으로 나눔</li>
...
<ul>
<li>
<p><strong>Page number (p)</strong><br>
→ 페이지 테이블에서 물리 메모리의 각 페이지에 해당하는 base address를 찾는 인덱스로 사용됨</p>
</li>
<li>
<p><strong>Page offset (d)</strong><br>
...
<li>
<p><strong>Associative Memory (TLB)</strong>: 병렬 탐색<br>
...
<li>이 작업을 빠르게 하기 위해 <strong>MMU (Memory Management Unit)</strong> 사용</li>
</ul>
