...
<ul>
<li>전용 I/O 명령어를 이용해 I/O 포트 주소 접근</li>
<li>메모리 매핑 I/O
<ul>
...
<li>장치 상태 판단 방식
<ul>
<li>Status register의 Busy bit 체크</li>
</ul>
</li>
<li>Busy-wait: 장치 준비될 때까지 대기
<ul>
...
<li>핸들러는 원인 분석, 처리 후 return from interrupt로 복귀</li>
</ul>
</li>
<li>두 종류의 인터럽트 요청 라인
<ul>
<li>Nonmaskable: 치명적 오류 등 마스킹 불가능</li>
<li>Maskable: CPU에 의해 제어 가능 (일반 I/O 인터럽트 등)</li>
</ul>
</li>
<li>인터럽트 벡터
<ul>
...
<li>각 장치에 해당하는 디바이스 컨트롤러</li>
<li>컨트롤러에 대응하는 디바이스 드라이버</li>
<li>커널의 I/O 서브시스템이 이들을 관리</li>
</ul>
</li>
</ul>
...
<li>Raw I/O (예: 데이터베이스 시스템) 또는 파일 시스템 접근</li>
<li>Memory-mapped file 접근 가능</li>
</ul>
</li>
<li>Character devices: 키보드, 마우스, 시리얼 포트 등
<ul>
