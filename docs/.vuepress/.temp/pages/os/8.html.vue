...
<li>외부 단편화를 줄이는 방법: <strong>compaction</strong>
<ul>
...
<li>Offset = 2 % 4 = 2</li>
<li>Logical address (m): 4비트</li>
<li>Page number (m-n): 2비트</li>
<li>Offset (n): 2비트</li>
...
<li><strong>문제점</strong>: 메모리 접근마다 <strong>두 번의 접근</strong>이 필요함
<ul>
<li>하나는 페이지 테이블, 다른 하나는 데이터/명령어 접근</li>
</ul>
</li>
<li><strong>해결책</strong>: <strong>TLB</strong>(Translation Look-aside Buffer) 또는 <strong>Associative memory</strong> 사용
<ul>
...
<li>Associative Memory (TLB): 병렬 탐색<br>
→ 페이지 테이블의 일부만 TLB에 저장됨</li>
<li>주소 변환 과정 (p, d)
<ul>
...
<li>메모리 접근 시간 = β</li>
<li><strong>Hit ratio = ε</strong> (연관 메모리에서 찾은 비율)</li>
<li>유효 접근 시간 (EAT: Effective Access Time)</li>
</ul>
