...
<ul>
<li>
<p><strong>프로젝트 마감일이 연장되었습니다.</strong></p>
<ul>
<li>GitHub에 <strong>5월 28일 11:59PM까지</strong> 제출하세요.</li>
<li>지각 제출은 5월 29일 11:59PM까지 이메일로 보내세요.</li>
<li>프로젝트 3은 29일에 공개됩니다.</li>
</ul>
</li>
<li>
<p><strong>이번 과제는 제공된 모든 테스트 케이스만 정확히 동작하면 통과입니다. (포기하지 마세요!)</strong></p>
<ul>
<li>예제의 출력 메시지는 예시일 뿐이므로 자유롭게 작성해도 됩니다.</li>
<li>출력 숫자나 순서는 정확히 일치할 필요 없습니다.</li>
<li>결과는 논리적으로 올바르면 됩니다.</li>
<li>결과가 다르게 나왔다면, 그 이유를 위키에 작성하세요.</li>
</ul>
</li>
</ul>
...
<ul>
<li>malloc은 내부적으로 sbrk를 호출합니다.</li>
</ul>
</li>
