...
<ul>
<li>현재 <code v-pre>fork()</code>는 부모의 모든 메모리를 즉시 복사함
<ul>
...
<li>해결책: 쓰기 시 복사 (Copy-on-Write, COW)
<ul>
...
<li><code v-pre>threetest()</code>: 다중 프로세스 COW 스트레스 테스트</li>
<li><code v-pre>filetest()</code>: COW와 시스템 콜 연동 (<code v-pre>copyout()</code> 호환성)</li>
</ul>
...
<li>대상 경로는 inode의 데이터 블록에 저장됨</li>
<li>새로운 시스템 콜: <code v-pre>symlink(target, path)</code></li>
<li>시스템 콜 인터페이스
<ul>
<li><code v-pre>sys_symlink()</code>: (1단계) 심볼릭 링크 파일 생성</li>
</ul>
</li>
<li>수정된 <code v-pre>open()</code>: (2단계) 심볼릭 링크를 직접 따라감
<ul>
...
<li><code v-pre>concur()</code> - 동시성 테스트</li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">...</span>
...
<li>구현 원본 xv6에서의 변경 사항에 초점을 맞춰 주요 코드 수정 사항과 그 목적을 설명하세요.</li>
<li>결과 다음을 포함하여 성공적인 구현의 증거를 보여주세요
<ul>
...
<ul>
<li>제출 브랜치를 만들고 리포지토리를 제출하세요.</li>
<li>리포지토리의 이름은 'os_project03_[학번]'입니다.</li>
</ul>
</li>
<li>위키 파일의 이름은 'os_project03_[분반]_[학번].pdf'이어야 합니다.</li>
<li>제출 마감일: 2025년 6월 19일 23:59
<ul>
