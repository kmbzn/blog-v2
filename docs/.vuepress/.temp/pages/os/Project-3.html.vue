...
<li>Write Access:
<ul>
<li>Page fault triggered on write attempt</li>
...
<li>threetest(): Multi-Process COW Stress Testing</li>
<li>filetest(): System Call Integration with COW (copyout() Compatibility)</li>
</ul>
...
<li>Solution: Doubly-Indirect Blocks
<ul>
...
<li>Target path stored in the inode's data blocks</li>
<li>New system call: <code v-pre>symlink(target, path)</code></li>
<li>System Call Interface:
<ul>
<li><code v-pre>sys_symlink()</code>: (Step 1) Create symlink file</li>
</ul>
</li>
<li>Modified <code v-pre>open()</code>: (Step 2) Follow symbolic links directly
<ul>
...
<li><code v-pre>concur()</code> - Concurrent Testing</li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">...</span>
...
<li>Implementation Explain key code modifications and their purpose, focusing on changes from the original xv6.</li>
<li>Results Show evidence of successful implementation with:
<ul>
...
<ul>
<li>Make the submission branch and submit your repository.</li>
<li>The name of the repository is 'os_project03_[studentID]'.</li>
</ul>
</li>
<li>The wiki file should be named 'os_project03_[class number]_[student ID].pdf'.</li>
<li>Submission deadline: June 19, 2025, 23:59
<ul>
