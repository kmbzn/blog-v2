...
<section class="print-section">
<h2 id="_2-핵심-원인-apparmor-보안-설정-해제" tabindex="-1"><a class="header-anchor" href="#_2-핵심-원인-apparmor-보안-설정-해제"><span>2. 핵심 원인: AppArmor 보안 설정 해제</span></a></h2>
