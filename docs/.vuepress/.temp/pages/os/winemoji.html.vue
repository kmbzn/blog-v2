...
<h1 id="wine-카카오톡-이모지-깨짐-문제-해결" tabindex="-1"><a class="header-anchor" href="#wine-카카오톡-이모지-깨짐-문제-해결"><span>Wine 카카오톡 이모지 깨짐 문제 해결</span></a></h1>
<DateMeta />
<p align="center">
...
<section class="print-section">
<h2 id="🛠-tested-environment" tabindex="-1"><a class="header-anchor" href="#🛠-tested-environment"><span>🛠 Tested Environment</span></a></h2>
<table>
<thead>
<tr>
<th></th>
