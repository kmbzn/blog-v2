...
<ul>
<li>클렌징 오일: 거의 100% 오일 베이스</li>
<li>클렌징 밀크: 오일이 물에 분산 → 부드럽고 가벼운 질감</li>
...
<p>세정력 순서 (일반적으로):</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">클렌징 오일 > 클렌징 밤 > 클렌징 밀크 > 클렌징 폼 > 클렌징 워터</span>
...
<tr>
<td>복합성</td>
<td>★★★★ (T존 피지 제거는 추가 클렌징 필요할 수 있음)</td>
</tr>
<tr>
<td>지성</td>
<td>★★★ (잔여감이 남을 수 있음)</td>
...
<tr>
<td>여드름성</td>
<td>★★★ (포뮬라에 따라 다름, 코메도제닉 성분 확인 필요)</td>
</tr>
</tbody>
</table>
...
<li>얼굴 전체에 부드럽게 마사지하듯 펴 바른다 (약 30~60초)</li>
<li>물을 약간 묻혀 유화(emulsification)시킨다 (하얗게 변하면서 느낌이 바뀜)</li>
<li>미온수로 깨끗이 씻어낸다</li>
</ol>
...
<ol>
<li>(1차) 클렌징 오일 또는 클렌징 밤으로 메이크업·선크림 제거</li>
...
<ul>
<li>세라마이드(Ceramide): 세정 중 장벽 성분 보충</li>
<li>판테놀(Panthenol): 진정, 수분 유지</li>
<li>글리세린(Glycerin): 보습</li>
</ul>
<p><strong>주의 성분</strong></p>
<ul>
<li>미네랄 오일(Mineral Oil): 코메도제닉 가능성, 여드름성 피부에 주의</li>
<li>SLS/SLES (소듐라우릴황산염): 거품 클렌저에서 자극이 되는 성분, 클렌징 밀크에는 적게 사용됨</li>
...
<tbody>
<tr>
<td>닥터지 브라이트닝 필링 젤</td>
<td>—</td>
<td>—</td>
</tr>
<tr>
<td><strong>에스트라 아토베리어365 클렌저</strong></td>
<td>세라마이드, 극저자극, 아토피 피부용</td>
<td>2만원대</td>
</tr>
<tr>
<td><strong>세타필 젠틀 스킨 클렌저</strong></td>
<td>무향, 피부과 추천, 세계적 베스트셀러</td>
<td>1~2만원대</td>
</tr>
<tr>
<td><strong>라로슈포제 에파클라 겔</strong></td>
<td>지성 피부용이지만 저자극</td>
<td>2만원대</td>
</tr>
<tr>
<td><strong>웰라쥬 리얼 히알루로닉 클렌징 밀크</strong></td>
<td>히알루론산 보습, 국내 브랜드</td>
<td>1만원대</td>
</tr>
<tr>
<td><strong>파울러 빌베리 클렌징 밀크</strong></td>
<td>식물성 원료, 건성·민감성 특화</td>
<td>3만원대</td>
</tr>
</tbody>
</table>
