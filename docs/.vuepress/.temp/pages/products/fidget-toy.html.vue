...
<ul>
<li><strong>구조</strong>: 중앙 베어링(ABEC-7 이상) + 3~5개 날개(또는 2개)</li>
<li><strong>소재</strong>: ABS 플라스틱 / 황동 / 스테인리스 스틸 / 티타늄</li>
<li><strong>특징</strong>: 회전 유지 시간(spin time)이 핵심 스펙. 고급 금속 베어링 사용 시 5~10분 이상 유지</li>
<li><strong>유행</strong>: 2017년 초 SNS에서 바이럴 → 전 세계 판매량 수억 개</li>
<li><strong>하락</strong>: 2017년 하반기부터 급격히 식었으나 매니아 층은 유지</li>
</ul>
<table>
<thead>
<tr>
...
<ul>
<li>실리콘 소재의 돌기를 누르면 &quot;딸깍&quot; 소리 + 촉감 → 반대편에서 다시 누르면 원상복구</li>
<li>다양한 형태(하트, 원, 공룡, 과일 등)와 컬러</li>
...
<ul>
<li><strong>마그네틱 링</strong>: 손가락 사이에서 회전하며 딸깍거림. 고급 버전은 티타늄 또는 스테인리스 스틸</li>
...
<p>감각 자극 피젯의 일종.</p>
<ul>
<li><strong>슬라임</strong>: 폴리비닐알코올(PVA) 풀 + 붕사/콘택트렌즈 세정제 혼합으로 만든 점탄성 소재. 늘리고 찌르는 촉감이 특징</li>
...
<ul>
<li>ADHD 아동에서 운동 자극(fidgeting)이 인지 과제 수행 시 도움이 된다는 연구 있음</li>
<li>반복적인 손 움직임이 코르티솔(스트레스 호르몬) 감소에 기여한다는 연구 있음</li>
<li>감각 처리 이상(자폐 스펙트럼 등)에서 자기 조절 도구로 유효하다는 임상 보고</li>
</ul>
<p><strong>부정적·중립적 연구</strong></p>
<ul>
<li>일반 초등학생 대상 연구에서 피젯 스피너가 수업 집중력을 <strong>저하</strong>시킨다는 결과</li>
<li>많은 효과 주장이 일화적(anecdotal) 근거에 머무름</li>
<li>대규모 임상 연구 부족</li>
</ul>
...
<tr>
<td>소음 없이 사무실에서</td>
<td>피젯 큐브 (무소음 버튼 면), 마그네틱 링</td>
</tr>
<tr>
<td>단순 손 자극, 이동 중</td>
<td>인피니티 큐브, 마그네틱 볼</td>
</tr>
<tr>
<td>아이와 함께</td>
<td>팝 잇, 킨에틱 샌드</td>
...
<tr>
<td>수집·마니아</td>
<td>고급 금속 피젯 스피너 (황동/티타늄)</td>
</tr>
<tr>
<td>감각 처리 지원</td>
<td>슬라임, 킨에틱 샌드, 텍스처 다양한 매시 토이</td>
</tr>
</tbody>
</table>
<p><strong>구매처</strong></p>
<ul>
<li>AliExpress: 가장 저렴, 배송 2~4주</li>
<li>다이소: 팝 잇, 기본 피젯 스피너 저렴하게 구비</li>
