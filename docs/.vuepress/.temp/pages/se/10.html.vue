...
<li>Solution Space (Object Model)
<ul>
<li>System 구현</li>
...
<ul>
<li>Domain model (a.k.a. conceptual model), 용어집</li>
</ul>
</li>
<li>System 동작 정의
<ul>
...
<li>Interaction diagrams를 통한 동작 탐색</li>
<li>설계 대안 탐색</li>
...
<li>Project 시작</li>
<li>요구사항 수집</li>
<li>Actors 및 use cases 정의</li>
<li><strong>문제 model / diagram, objects 정의</strong></li>
...
<li>Problem domain의 개념 찾기
<ul>
<li>Real-world abstractions, 반드시 software objects는 아님</li>
</ul>
</li>
<li>문제 이해</li>
<li>공통 어휘 확립</li>
...
<ul>
<li>명사, 동사, 개념 간 관계 식별</li>
<li>&quot;System&quot;과 같은 non-specific한 어휘 지양</li>
<li>Operations와 concepts 구분</li>
<li>Domain 전문가와 brainstorming</li>
</ul>
</li>
</ul>
...
<li>
<p>개발자와 고객 간의 공유된 이해 보장</p>
<pre><code>       ┌─── 모호할 수 있는 개념 정의 ──────┐   
</code></pre>
<p>┌────────▼───────────────────────────────────┼──┐
...
<li>범주 list 사용
<ul>
<li>유형의 사물: <code v-pre>cars</code>, <code v-pre>telemetry data</code>, <code v-pre>terminals</code> 등</li>
<li>역할: <code v-pre>mother</code>, <code v-pre>teacher</code>, <code v-pre>researcher</code></li>
<li>이벤트: <code v-pre>landing</code>, <code v-pre>purchase</code>, <code v-pre>request</code></li>
<li>상호작용: <code v-pre>loan</code>, <code v-pre>meeting</code>, <code v-pre>intersection</code> 등</li>
<li>구조, 장치, 조직 단위 등</li>
</ul>
</li>
...
<li>실제 세계의 &quot;is-a&quot; 관계는 domain model에 적합</li>
<li>실제 세계의 추상화는 domain model에 적합</li>
<li>반복이 중요: 이 예시는 초안임. 실제 설계에서는 일부 용어 수정 가능성
<ul>
<li>예: <code v-pre>Item</code> vs. <code v-pre>LibraryItem</code>, <code v-pre>Account</code> vs. <code v-pre>LibraryAccount</code></li>
</ul>
</li>
...
<li>Domain 이해
<ul>
<li>세부사항이 중요! (예: System에게 책과 비디오는 다른가?)</li>
</ul>
</li>
<li>완전성 보장
<ul>
...
<li>공통 용어 집합에 동의
<ul>
<li>예: <code v-pre>library item</code> vs <code v-pre>collection entry</code> vs <code v-pre>book</code></li>
</ul>
</li>
<li>설계 준비
<ul>
<li>Domain concepts는 OO classes의 좋은 후보 (-&gt; low representational gap)</li>
</ul>
</li>
</ul>
...
<ul>
<li>개발자, 테스터, 고객, domain 전문가 간 communication을 위함</li>
<li>단일 어휘에 동의하고 시각화</li>
</ul>
</li>
<li>Software classes나 data가 아닌, concepts에 집중
<ul>
<li>아이디어, 사물, objects</li>
<li>이름 부여, 정의 및 예시 제공 (symbol, intension, extension)</li>
</ul>
</li>
...
<ul>
<li>반드시 저장될 data는 아님</li>
</ul>
</li>
<li>VS. object model 및 Java classes (solution space)
<ul>
<li>실제 domain concepts만 포함 (실제 objects 또는 실제 세계의 추상화)</li>
<li>&quot;UI frame&quot;, database 등 미포함</li>
</ul>
</li>
</ul>
...
<li>System 수준의 텍스트 명세, software specifications와 유사</li>
</ul>
</li>
</ul>
...
<li>Helper methods 또는 classes</li>
<li>Design patterns의 산출물</li>
</ul>
</li>
</ul>
...
<li>Domain 전문가로부터 feedback 받기
<ul>
<li>Domain 수준의 concepts만 사용</li>
</ul>
</li>
</ul>
</div></template>
