...
<li>Usability, reliability, security, robustness (일반 및 아키텍처), performance, integration과 같은 품질 속성 평가를 위한 testing 전략 열거</li>
<li>Trade-off를 제시하고 각 technique이 유용할 수 있는 시점 식별</li>
...
<li>Microsoft와 같은 대형 상용 소프트웨어 회사에서는 development만큼 testing 수행</li>
<li>Developer만큼 많은 tester 보유. Tester는 항상 testing 수행, developer는 약 절반의 시간을 testing 과정에 참여</li>
<li>Test case는 매우 비쌈. 프로그램 자체보다 test harness에 더 많은 code 라인 존재 (종종 약 3:1 비율)</li>
<li>Time Estimates (in hours):</li>
</ul>
<table>
<thead>
<tr>
...
<ul>
<li>Questions</li>
<li>Specification이 올바른지 어떻게 보장하는가?</li>
<li>시스템이 specification을 충족하는지 어떻게 보장하는가?</li>
...
<ul>
<li>즉, 시스템을 올바르게 구축했는가?</li>
</ul>
</li>
<li>Verification: Design 또는 code에 결함이 있는가?
<ul>
<li>즉, 잘못된 design 또는 implementation 결정이 있는가?</li>
</ul>
</li>
<li>Validation: 시스템이 사용자의 요구를 충족하는가?
<ul>
<li>즉, 올바른 시스템을 구축했는가?</li>
</ul>
</li>
<li>Validation: Specification에 결함이 있는가?
<ul>
<li>즉, requirements 캡처를 잘못 수행했는가?</li>
</ul>
</li>
</ul>
...
<li>어떤 technique이 적절한지는 여러 요인에 따라 다름
<ul>
<li>해당 시스템 (및 크기/복잡성), 품질 목표, 가용 resource, 안전/보안 요구사항 등</li>
</ul>
</li>
</ul>
...
<li>포괄적이 되려는 시도
<ul>
<li>예: Test coverage, inspection check list, exhaustive model checking</li>
</ul>
</li>
<li>자동: Regression testing, static analysis, dynamic analysis</li>
...
<li>Dynamic:
<ul>
<li>Testing: 통제된 환경에서 test data로 code를 직접 실행</li>
<li>Analysis: Test run에서 data를 추출하는 tool</li>
</ul>
</li>
<li>Static:
<ul>
<li>Inspection: Code, design 문서 (spec 및 model), 수정 사항에 대한 인간의 평가</li>
<li>Analysis: Tool이 program을 실행하지 않고 reasoning</li>
</ul>
</li>
</ul>
...
<li>주요 목표:
<ul>
<li>Verification: Program이 품질 속성을 포함한 requirements를 충족하는지 확인</li>
<li>Defect testing: Failure 발견</li>
</ul>
</li>
<li>기타 목표:
<ul>
<li>Reveal bugs (주요 목표)</li>
<li>Assess quality (정량화 어려움)</li>
<li>Clarify the specification, documentation</li>
...
<li>Usability errors</li>
<li>Robustness errors</li>
<li>Load errors</li>
<li>Design defects</li>
<li>Versioning and configuration errors</li>
...
<ul>
<li>Execution space (white box!)</li>
<li>Input 또는 requirements space (black box!)</li>
</ul>
</li>
<li>예상되는 사용자 경험 (usability)
<ul>
<li>GUI testing, A/B testing</li>
</ul>
</li>
<li>예상되는 performance envelope (performance, reliability, robustness, integration)
<ul>
<li>Security, robustness, fuzz, infrastructure testing</li>
<li>Performance 및 reliability: soak 및 stress testing</li>
<li>Integration 및 reliability: API/protocol testing</li>
</ul>
</li>
</ul>
...
<li>주어진 verification 활동이 목표를 달성한 정도를 측정. 활동의 adequacy 근사</li>
...
<ul>
<li>Test 우선!</li>
<li>인기 있는 agile technique</li>
<li>Code 작성 전 specification으로 test 작성</li>
<li>실패하는 test 없이 code 작성 금지</li>
<li>주장:
<ul>
<li>Testable design을 향한 design 접근 방식</li>
<li>Interface 우선 고려</li>
<li>불필요한 code 작성 방지</li>
<li>더 높은 제품 품질 (예: 더 나은 code, 더 적은 defect)</li>
<li>더 높은 test suite 품질</li>
<li>더 높은 전반적인 생산성</li>
</ul>
</li>
</ul>
...
<li>일반적인 model:
<ul>
<li>Bug fix 등을 위해 regression test 도입</li>
<li>Code가 evolve함에 따라 결과 비교</li>
</ul>
</li>
<li>Code1 + TestSet -&gt; TestResults1</li>
<li>Code2 + TestSet -&gt; TestResults2</li>
<li>Code가 evolve함에 따라 TestResults1을 TestResults2 등과 비교</li>
<li>Specification이 변경되지 않는 한 동일해야 함</li>
<li>이점:
<ul>
<li>Bug fix가 유지되고 bug가 다시 나타나지 않도록 보장</li>
<li>Specification에 대한 의존도 감소</li>
</ul>
</li>
</ul>
...
<ul>
<li>Specification?</li>
<li>Test harness? Environment?</li>
...
<ul>
<li>어려움</li>
<li>Capture and Replay Strategy
<ul>
<li>Mouse actions</li>
<li>System events</li>
</ul>
</li>
<li>Test Scripts: (&quot;Start&quot; 버튼 클릭, Y 필드에 값 X 예상)</li>
<li>많은 tool 및 framework
<ul>
<li>예: JUnit + Jemmy (Java/Swing)</li>
<li>Selenium (Web)</li>
</ul>
</li>
...
<ul>
<li>Live System?</li>
<li>Extra Testing System?</li>
<li>Check output / assertions?</li>
<li>Effort, Costs?</li>
<li>Reproducible?</li>
</ul>
...
<ul>
<li>Program의 input domain 식별</li>
<li>난수를 해당 input domain에 mapping</li>
<li>특정 확률 분포에 따라 input domain에서 input 선택</li>
<li>해당 input에 대해 program이 적절한 output을 달성하는지 확인</li>
</ul>
</li>
...
<li>Not checking return codes</li>
<li>Invalid/out of boundary data</li>
<li>Data corruption</li>
<li>Signed characters</li>
<li>Race conditions</li>
...
<ul>
<li>예: Memory leak은 failure로 이어지는 데 더 오래 걸릴 수 있음</li>
</ul>
</li>
...
<li>&quot;악의적인&quot; program이 component, network, datacenter, AWS instance 등을 무작위로 손상</li>
<li>Chaos monkey가 최초 – production instance를 무작위로 비활성화</li>
<li>다른 monkey로는 Latency Monkey, Doctor Monkey, Conformity Monkey 등이 있음. Infrastructure level에서의 Fuzz testing</li>
...
<li>통계적 threshold
<ul>
<li>보고된/수리된 defect</li>
<li>Defect 종류의 상대적 비율</li>
<li>&quot;Going gold&quot; 예측 변수</li>
</ul>
</li>
<li>Coverage criterion
<ul>
<li>예: 항공 software에 100% coverage 필요</li>
<li>Software 왜곡</li>
<li>Matrix: Test case를 requirements use case에 mapping</li>
</ul>
</li>
<li>과거 data 참조 가능
<ul>
<li>조직 내에서 project 간 비교 가능. 기대치 및 예측 변수 개발</li>
<li>조직 간에는 commensurability의 어려움으로 인해 더 어려움 (예: 항공 software vs. 소비자 software)</li>
</ul>
</li>
...
<li>Oracle problem</li>
<li>Nondeterminism, flaky tests
<ul>
<li>특정 종류의 bug는 매우 드문 조건에서만 발생</li>
</ul>
</li>
<li>Specification 관찰/단언 어려움
<ul>
<li>Memory leaks, information flow, …</li>
</ul>
</li>
<li>잠재적으로 비싸고 긴 실행 time</li>
<li>잠재적으로 높은 manual effort</li>
