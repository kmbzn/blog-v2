...
<li>THERAC-25 방사선 기계: safety-critical software(안전 필수 소프트웨어)의 부실한 테스트가 생명을 앗아갈 수 있음: 환자 3명 사망</li>
<li>Mars Polar Lander 추락 지점?</li>
<li>THERAC-25 design(설계)</li>
<li>Ariane 5: exception-handling(예외 처리) 버그: 첫 비행(maiden flight)에서 강제 자폭(64-bit에서 16-bit로 변환: 약 3억 7천만 달러 손실)</li>
...
<li>Boeing A220: 소프트웨어 업데이트가 과도한 진동을 허용한 후 엔진 고장</li>
<li>Toyota 브레이크: 수십 명 사망, 수천 건의 충돌</li>
...
<ul>
<li>변화하는 조선 명령</li>
<li>수정된 용골(keel)에 대한 명세(specifications) 부재</li>
<li>변경되는 군비 요구사항</li>
<li>조선 장인의 죽음</li>
</ul>
</li>
<li>(Architecture(아키텍처) &amp; Design(설계))
<ul>
<li>안정성(stability), 강성(stiffness), 항해 특성을 계산할 방법 부재</li>
</ul>
</li>
<li>QA
<ul>
<li>사전 진수 안정성 테스트 실패</li>
</ul>
</li>
<li>DevOps(데브옵스)</li>
<li>Metrics</li>
...
<li>소프트웨어 업데이트보다 더 지속적인 콘텐츠 업데이트</li>
<li>콘텐츠 <em>와</em> 파서(parser)의 불충분한 테스트</li>
<li>staged roll-outs(단계적 배포) 부재.</li>
<li>영향 발생 후 원격으로 문제 해결 방법 부재.</li>
...
<ul>
<li>소프트웨어의 낮은 품질.</li>
<li>소프트웨어 개발에 드는 시간, 노력, 비용 예측 불가능성.</li>
<li>하드웨어 대 S/W 비용 비율의 변화</li>
<li>maintenance(유지보수)의 역할 증대</li>
<li>하드웨어의 발전</li>
<li>소프트웨어 기술의 발전</li>
...
<ul>
<li>A: 2%(납품되어 작동)</li>
<li>B: 3%(일부 수정 후 작동)</li>
<li>C: 45%(납품되었으나 성공적으로 사용된 적 없음)</li>
...
<li>Complex(복잡함)</li>
<li>Flexible(유연함)</li>
<li>완전히 자동화될 수 없음; 인간 개입</li>
<li>비교적 짧은 역사</li>
</ul>
</li>
<li>Difficulties(어려움)
<ul>
<li>correctness(정확성) 보장 난해</li>
<li>과학적 원칙(disciplines)이 현장에 거의 적용되지 않음</li>
<li>이해하기 어려움</li>
</ul>
</li>
</ul>
...
<ul>
<li>S/W 마인드 부족</li>
<li>불충분한 software project management(소프트웨어 프로젝트 관리)</li>
<li>적절한 SE(소프트웨어 공학) 기술 부족</li>
<li>What is Software Engineering(소프트웨어 공학)?</li>
...
<li>(The Free On-Line Dictionary of Computing)</li>
<li>“컴퓨터 기반 애플리케이션 개발에 tools(도구)와 techniques(기법)를 체계적으로 적용하는 것.”</li>
<li>(Sue Conger in The New Software Engineering)</li>
...
<li>도발적인 제목
<ul>
<li>소프트웨어 공학은 널리 사용되는 용어가 아니었음</li>
</ul>
</li>
<li>행동 촉구(Call for Action)</li>
...
<li>“[소프트웨어 공학은] reliable(신뢰할 수 있고) real machines(실제 기계)에서 efficiently(효율적으로) 작동하는 소프트웨어를 economically(경제적으로) 얻기 위해 sound engineering principles(건전한 공학 원칙)을 수립하고 사용하는 것.”</li>
...
<ul>
<li>원하는 출력(deliverables(산출물))이 잘 정의됨</li>
<li>잘 정의된 입력(즉, 문서화된 구문(syntax), 의미(semantics), 컨텍스트(context) 및 입력의 기타 관련 속성)을 사용</li>
<li>잘 정의된 process(프로세스)(예: 프로세스 간 통신, 데이터 형식, 오류 처리 등에 대한 조직 표준 사용)</li>
<li>그 출력이 다음 프로세스(들)에서 유사하게 입력으로 사용됨</li>
<li>최종 출력이 달성될 때까지</li>
<li>출력의 정확성이 verifiable(검증 가능)함.</li>
</ul>
</li>
...
<ul>
<li>(예: 누가 누구를 관리하는지, 누가 무엇을 책임지는지?),</li>
</ul>
</li>
...
<li>Requirements elicitation(요구사항 도출), 문서화 및 평가</li>
<li>quality attributes(품질 속성)를 위한 설계</li>
<li>quality assurance(품질 보증) 전략</li>
<li>소프트웨어 공학의 Empirical methods(경험적 방법론)</li>
...
<li>언제, 얼마나 많이 설계하는가?</li>
<li>언제, 얼마나 많이 테스트하는가?</li>
<li>언제, 어떻게 고객을 참여시키는가?
<ul>
<li>Agile methods(애자일 방법론)</li>
</ul>
</li>
</ul>
...
<li>또 다른 이해관계자(interest)는 누구인가?</li>
...
<li>무엇을 automate(자동화)할 수 있고 언제 humans in the loop(인간 참여)를 유지해야 하는가?</li>
<li>얼마나 많은 테스트와 어떤 종류의 테스트를 수행해야 하는가?</li>
<li>functional correctness(기능적 정확성) 외에 보증해야 할 중요한 품질은 무엇인가?</li>
...
<li>문제를 조기에 인식하기 위해 진행 상황과 위험(risks)을 어떻게 모니터링하는가?</li>
<li>팀 내 개발자들을 어떻게 조정(coordinate)하는가?</li>
<li>팀을 어떻게 구성하고 발전시키는가?</li>
