...
<tbody>
<tr>
<td><strong>마모 (Abrasion)</strong></td>
<td>칫솔질 방향 및 압력. 옆으로 강하게 닦는 습관이 치경부를 물리적으로 마모시킴</td>
</tr>
<tr>
<td><strong>부식 (Erosion)</strong></td>
<td>탄산음료, 과일즙, 위산 역류 등 산성 물질에 의한 법랑질·상아질 용해</td>
</tr>
<tr>
<td><strong>굴곡 피로 (Abfraction)</strong></td>
<td>강한 교합력이 치아에 반복적으로 작용해 치경부에 응력이 집중, 미세 균열 발생</td>
</tr>
</tbody>
</table>
...
<li><strong>칫솔이 닿을 때 통증</strong>: 칫솔이 패인 부위에 직접 닿으면 예민하게 느껴짐</li>
...
<ol>
<li><strong>표면 처리</strong>: 패인 부위를 미세하게 정리하고 세정</li>
<li><strong>산부식 (Acid Etching)</strong>: 인산(phosphoric acid, 약 37%) 젤을 도포해 치면에 미세한 요철 생성 → 레진이 물리적으로 결합할 면적 확보</li>
<li><strong>본딩제 도포 (Bonding Agent)</strong>: 산부식 면에 접착 성분을 발라 화학적 결합층 생성</li>
<li><strong>레진 충전</strong>: 치아색과 유사한 레진을 분층 적층(incremental build-up)하며 채움</li>
<li><strong>광중합 (Light Curing)</strong>: LED/할로겐 큐어링 라이트로 레진을 굳힘 (각 층마다 반복)</li>
...
<tr>
<td>일반적인 시술 비용</td>
<td><strong>약 7만원 전후</strong> (치아당)</td>
</tr>
<tr>
<td>보험 적용 여부</td>
<td>비급여 (건강보험 미적용)</td>
...
<tr>
<td>일반적</td>
<td><strong>3~7년</strong></td>
</tr>
<tr>
<td>칫솔질 습관 개선 + 관리 철저</td>
<td>10년 이상 가능</td>
</tr>
<tr>
<td>교합 이상(이갈이 등) 지속</td>
<td>2~3년 이내 탈락 가능</td>
</tr>
</tbody>
</table>
...
<ul>
<li><strong>올바른 칫솔질</strong>: 위아래로 쓸어내리는 방향으로, 압력을 줄이고</li>
<li><strong>칫솔 선택</strong>: 부드러운(soft) 칫솔모 사용</li>
<li><strong>산성 음식 후 30분 대기</strong>: 탄산음료·과일주스 섭취 직후 칫솔질 금지 (산 부식 후 법랑질이 연화된 상태)</li>
<li><strong>이갈이 교정</strong>: 야간 이갈이가 있다면 마우스피스(교합안정장치) 착용</li>
</ul>
