...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="logical-vs-physical-address-space" tabindex="-1"><a class="header-anchor" href="#logical-vs-physical-address-space"><span>Logical vs. Physical Address Space</span></a></h2><ul><li><p>논리 주소 공간(logical address space) 개념은 물리 주소 공간(physical address space)과 분리되어 있으며, 이는 적절한 메모리 관리의 핵심임</p></li><li><p>Logical address</p><ul><li>CPU에 의해 생성됨</li><li>virtual address라고도 불림</li></ul></li><li><p>Physical address</p><ul><li>메모리 장치에 의해 인식되는 주소</li></ul></li><li><p>논리 주소와 물리 주소는 컴파일 시간과 적재 시간 바인딩에서는 동일함</p></li><li><p>실행 시간 바인딩에서는 서로 다름</p></li></ul><h2 id="memory-management-unit-mmu" tabindex="-1"><a class="header-anchor" href="#memory-management-unit-mmu"><span>Memory-Management Unit (MMU)</span></a></h2><ul><li><p>MMU (Memory-Management Unit)</p><ul><li>논리 주소를 물리 주소로 변환해주는 하드웨어 장치</li></ul></li><li><p>MMU 방식</p><ul><li>relocation register의 값을 CPU에서 전달된 모든 주소에 더한 후 메모리에 보냄</li></ul></li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">  [ CPU ]</span>
<span class="line">     │</span>
<span class="line">     ▼</span>
<span class="line">  ┌─────────────┐</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>사용자 프로그램은 논리 주소만 다루며, 물리 주소는 직접 접근하지 않음</li></ul><h2 id="swapping-necessitates-dynamic-relocation" tabindex="-1"><a class="header-anchor" href="#swapping-necessitates-dynamic-relocation"><span>Swapping necessitates dynamic relocation</span></a></h2><ul><li><p><strong>Swapping</strong></p><ul><li>프로세스는 일시적으로 메모리에서 backing store로 스왑됨</li><li>이후 다시 메모리로 복귀됨</li></ul></li><li><p><strong>Backing store</strong></p><ul><li>모든 사용자 메모리 이미지를 저장할 수 있을 만큼 큰 고속 디스크</li><li>사용자들이 직접 접근할 수 있어야 함</li></ul></li><li><p>스왑에서 가장 큰 비중을 차지하는 것은 전송 시간</p><ul><li>총 전송 시간은 스왑되는 메모리 양에 비례함</li></ul></li></ul><h2 id="contiguous-allocation" tabindex="-1"><a class="header-anchor" href="#contiguous-allocation"><span>Contiguous Allocation</span></a></h2><ul><li><p>주기억장치는 일반적으로 두 파티션으로 나뉨:</p><ul><li>Resident OS: interrupt vector가 있는 low memory에 위치</li><li>User process는 high memory에 위치</li></ul></li><li><p>사용자 프로세스를 보호하기 위해:</p><ul><li><strong>Relocation register</strong>: 가장 작은 물리 주소 값을 가짐</li><li><strong>Limit register</strong>: 논리 주소 범위를 가짐 <ul><li>각 논리 주소는 limit register로 경계 설정됨</li></ul></li></ul></li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">  ┌────────────┐</span>
<span class="line">  │     OS     │ ← low memory</span>
<span class="line">  └────────────┘</span>
<span class="line">  ┌────────────┐</span>
<span class="line">  │ user proc. │ ← high memory</span>
<span class="line">  └────────────┘</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="hardware-support-for-relocation-and-limit-registers" tabindex="-1"><a class="header-anchor" href="#hardware-support-for-relocation-and-limit-registers"><span>Hardware Support for Relocation and Limit Registers</span></a></h2><ul><li>하드웨어는 relocation과 limit register를 사용하여 주소를 변환함</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">  [ CPU ]</span>
<span class="line">     │</span>
<span class="line">     ▼</span>
<span class="line"> ┌────────────┐</span>
<span class="line"> │ logical addr│</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="address-translation-scheme-in-paging" tabindex="-1"><a class="header-anchor" href="#address-translation-scheme-in-paging"><span>Address Translation Scheme in Paging</span></a></h2><ul><li><p>CPU가 생성하는 주소는 다음 두 부분으로 나뉨:</p><ul><li><p>Page number (p)<br> → 페이지 테이블에서 물리 메모리의 각 페이지에 해당하는 base address를 찾는 인덱스로 사용됨</p></li><li><p>Page offset (d)<br> → base address에 더해 실제 메모리 접근 주소를 결정</p></li></ul></li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">주소 구조:</span>
<span class="line"></span>
