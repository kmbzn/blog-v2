...
2020년 Google은 Workspace 전체 아이콘을 통일된 원칙 아래 재설계했다. 규칙은 하나였다.
...
흥미로운 점은 비판의 방향이 2020년과 **정반대**라는 것이다. 2020년에는 "너무 똑같이 생겼다"가 불만이었고, 2026년에는 "너무 달라졌다"는 반응이 나온다. 이는 디자인 변경 자체가 유발하는 낯섦과, 실제 사용성 문제를 구분해서 봐야 한다는 것을 시사한다.
