...
- 운영 주체: **은행**
- 예금자보호 여부: **보호 (1인 1금융기관 기준 최대 1억원)**
...
| 종금형 | 종합금융회사 운영 (현재 극소수) | 예금자보호 적용 (1억원) |
...
1억원 이하 단기 자금이라면 **파킹통장**이 안정적이다. 금리 차이(0.5~1%p)가 있지만, 예금자보호가 주는 안전성은 그 이상의 가치가 있다.

1억원 초과 여유 자금이라면 어차피 예금자보호를 초과하므로, CMA의 높은 금리를 선택하거나 두 상품을 분산해서 사용하는 것이 현명하다.
...
::: warning 예금자보호 한도
예금자보호는 1인 1금융기관(은행) 기준 원금+이자 합산 **1억원**까지 보호한다. 2개 이상의 은행에 나눠 예치하면 각 은행별로 1억원까지 보호받는다. 증권사 RP형 CMA는 예금자보호 대상이 아니다.
:::
