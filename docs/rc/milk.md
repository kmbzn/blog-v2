...
디지털 기기와 앱의 급속한 확산으로 인해 사람들은 e-commerce나 짧은 영상 공유 플랫폼과 같이 풍부한 멀티미디어 콘텐츠에 노출되어 있습니다. 멀티미디어 기반 추천 시스템은 이러한 온라인 서비스의 필수 요소로 자리 잡았으며, 멀티미디어 콘텐츠로부터 사용자 선호도를 학습하여 개인화된 아이템 추천을 목표로 합니다. 이러한 모델들의 핵심 아이디어는 사전 학습된 특징으로부터 아이템 콘텐츠 표현을 더 잘 모델링하고, 사용자의 이력 기록을 활용해 사용자의 콘텐츠 선호도를 정렬하는 것입니다.
...
이 연구는 중국 국가 핵심 연구개발 프로그램(Grant No.2021ZD0111802), 중국 국가자연과학재단(Grant No.U23B2031, 72188101), 중앙대학기초연구기금(Grant No.JZ2023HGQA0471)의 부분적인 지원을 받았습니다.
