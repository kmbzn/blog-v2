...
- **Process:** System sequence diagram에서 도출 (원칙: Low representational gap, high cohesion)
...
- Design process: Domain model에서 도출
 - 원칙: Low representational gap, low coupling
...
- Process: Domain model, interaction diagrams에서 추출
 - 원칙: Low coupling, low representational gap
