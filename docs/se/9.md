...
- 기본 UML 표기법을 사용하여 설계를 전달
- 다양한 유형의 UML diagram의 표기법과 목적 이해
...
```diagram
                     ...
                     │                    │                   │             
                     ▼                    ▼                   ▼             
 ┌─┐turn PC on┌─────────┐            ┌─────────┐terminate┌──────────┐  ┌───┐
 │ ├─────────►│ Booting ├───────────►│ Working ├────────►│ Shutting ├─►│ ┼ │
 └─┘          └─────────┘            └─────┬───┘         │  Down    │  └───┘
Initial                  keyStrock or    ▲ │             └──────────┘   ▲   
 State                   mouseMovement   │ │ [is Timeout]/              │   
                                         │ ▼ popUpScreenShot()   Final State
                                      ┌──┴─────┐                            
                                      │ Screen │◄─── State                       
                                      │ Saving │                            
                                      └────────┘                            
...
└─┘on        └─────────┘            └─────┬───┘         │  Down    │  └───┘
                        keyStrock or    ▲ │             └──────────┘       
                        mouseMovement   │ │ [is Timeout]/◄──Guard Condition
                          ▲             │ ▼ popUpScreenShot()              
                          │          ┌──┴─────┐     ▲                      
                      Event          │ Screen │     │                      
                                     │ Saving │     │                      
