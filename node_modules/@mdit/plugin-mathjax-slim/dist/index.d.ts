...
import { ChtmlFontData } from "@mathjax/src/js/output/chtml/FontData.js";
import { ChtmlWrapperFactory } from "@mathjax/src/js/output/chtml/WrapperFactory.js";
import { LinebreakVisitor } from "@mathjax/src/js/output/common/LinebreakVisitor.js";
import { SvgFontData } from "@mathjax/src/js/output/svg/FontData.js";
import { SvgWrapperFactory } from "@mathjax/src/js/output/svg/WrapperFactory.js";
import { CssStyles } from "@mathjax/src/js/ui/menu/mj-context-menu.js";
import { LiteAdaptor } from "@mathjax/src/js/adaptors/liteAdaptor.js";
import { CHTML } from "@mathjax/src/js/output/chtml.js";
import { SVG } from "@mathjax/src/js/output/svg.js";
import MarkdownIt from "markdown-it";

//#region src/mathjax.d.ts
...
interface MathjaxCommonOutputOptions {
  ...
  linebreaks?: {
     ...
     * @default 0.2
     */
    lineleading?: number; /** For developers only */
...
interface MathjaxInstance<Sync extends boolean = false> extends Required<Pick<MarkdownItMathjaxOptions, "allowInlineWithSpace" | "delimiters" | "mathFence">> {
  /** Mathjax adaptor */
  adaptor: LiteAdaptor;
...
declare const getDocumentOptions: (options: MarkdownItMathjaxOptions) => Promise<DocumentOptions>;
declare const createMathjaxInstance: (options?: MarkdownItMathjaxOptions) => Promise<MathjaxInstance | null>;
declare const mathjax: (md: MarkdownIt, {
  ...
  mathFence,
  transformer
}: MathjaxInstance) => void;
//#endregion
export { type DocumentOptions, type MarkdownItMathjaxOptions, type MathJaxTexInputOptions, type MathjaxCommonHTMLOutputOptions, type MathjaxCommonOutputOptions, type MathjaxFilter, type MathjaxFilterData, type MathjaxInstance, type MathjaxSVGOutputOptions, type TeXTransformer, type TexPackage, createMathjaxInstance, getDocumentOptions, mathjax };
