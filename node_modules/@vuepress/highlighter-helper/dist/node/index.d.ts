...
interface MarkdownItLineNumbersOptions {
   ...
   *
   * - If `number`, show line numbers with code block lines not less than
   *   `number`.
   * - If `true`, show line number always
   * - If `false`, do not enable line numbers globally, but you can enable it for
   *   individual code blocks using `:line-numbers`
  ...
  /**
   * Custom resolving function that whether to enable line numbers for a single
   * code block
   *
...
//#endregion
export { type CodeBlockTitleRender, type MarkdownItCodeBlockTitleOptions, type MarkdownItCollapsedLinesOptions, type MarkdownItLineNumbersOptions, NO_WHITESPACE_REGEXP, WHITESPACE_REGEXP, WhitespacePosition, codeBlockTitle, collapsedLines, lineNumbers, resolveAttr, resolveWhitespacePosition };
