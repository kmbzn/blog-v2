import { a as GitInjectOptions, c as GitPluginPageData, d as SubmoduleInfo, i as GitData, l as GitUrlPattern, n as GitChangelogInfo, o as GitLocaleData, r as GitContributorInfo, s as GitPluginFrontmatter, t as CoAuthorInfo, u as KnownGitProvider } from "../index-Dx4FCOD1.js";
 ...
 * @returns True if it's a Git repository, false otherwise / 如果是 Git 仓库则返回
 *   true，否则返回 false
 */
 ...
 *   a git repository
 */
declare const getGitRepoRoot: (filePath: string, cwd: string) => Promise<string | null>;
/**
...
declare const clearGitRepoRootCache: () => void;
//#endregion
 ...
 */
declare const normalizeRepoUrl: (url: string) => string;
/**
...
//#endregion
export { type ChangelogOptions, type CoAuthorInfo, type ContributorInfo, type ContributorsOptions, type GitChangelogInfo, type GitContributorInfo, type GitData, type GitInjectOptions, type GitLocaleData, type GitPluginFrontmatter, type GitPluginOptions, type GitPluginPageData, type GitUrlPattern, type KnownGitProvider, type MergedRawCommit, PLUGIN_NAME, type RawCommit, type SubmoduleInfo, checkGitRepo, checkGithubUsername, clearGitRepoRootCache, digestSHA256, getCommits, getContributorInfo, getGitRepoRoot, getRawCommits, getRawContributors, getRemoteUrl, getUserNameWithNoreplyEmail, gitPlugin, inferGitProvider, injectGitOptions, logger, mergeRawCommits, normalizeRepoUrl, resolveChangelog, resolveContributors, sanitizeHTML };
